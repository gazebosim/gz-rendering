...
class gz::rendering::OgreNextWireBoxPrivate
{
  /// \brief Wirebox material
  public: OgreNextMaterialPtr material;

  /// \brief Ogre renderable used to render the wirebox.
  public: std::shared_ptr<OgreNextDynamicRenderable> wireBox = nullptr;
};

//////////////////////////////////////////////////
OgreNextWireBox::OgreNextWireBox()
    : dataPtr(new OgreNextWireBoxPrivate)
{
}
...
//////////////////////////////////////////////////
void OgreNextWireBox::PreRender()
{
  GZ_PROFILE("Ogre2WireBox::PreRender");
...
//////////////////////////////////////////////////
Ogre::MovableObject *OgreNextWireBox::OgreObject() const
{
  return this->dataPtr->wireBox->OgreObject();
}

//////////////////////////////////////////////////
void OgreNextWireBox::Init()
{
  this->Create();
}

//////////////////////////////////////////////////
void OgreNextWireBox::Create()
{
  if (!this->dataPtr->wireBox)
  {
    this->dataPtr->wireBox.reset(new OgreNextDynamicRenderable(this->scene));
  }
...
//////////////////////////////////////////////////
void OgreNextWireBox::SetMaterial(MaterialPtr _material, bool _unique)
{
...
//////////////////////////////////////////////////
void OgreNextWireBox::SetMaterialImpl(OgreNextMaterialPtr _material)
{
...
//////////////////////////////////////////////////
MaterialPtr OgreNextWireBox::Material() const
{
