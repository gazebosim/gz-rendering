 ...
 *
 */
#ifndef GZ_RENDERING_OGRE_NEXT_OGRE_NEXTRENDERTARGET_HH_
#define GZ_RENDERING_OGRE_NEXT_OGRE_NEXTRENDERTARGET_HH_
...
#include "gz/rendering/ogre_next/OgreNextRenderTargetMaterial.hh"
...
namespace gz
{
  namespace rendering
  {
    ...
    //
    // forward declaration
    class OgreNextRenderTargetPrivate;

    /// \brief OgreNext.x implementation of the render target class
    class GZ_RENDERING_OGRE_NEXT_VISIBLE OgreNextRenderTarget :
      public virtual BaseRenderTarget<OgreNextObject>
    {
      /// \brief Constructor
      protected: OgreNextRenderTarget();

      /// \brief Destructor
      public: virtual ~OgreNextRenderTarget();
      ...
      /// and value specified in OgreNextRenderTarget::AntiAliasing
      ...
      /// \sa OgreNextRenderTarget::RebuildImpl()
      ...
      protected: OgreNextRenderTargetMaterialPtr materialApplicator;
      ...
      private: std::unique_ptr<OgreNextRenderTargetPrivate> dataPtr;
    };

    /// \brief OgreNext.x implementation of the render texture class
    class GZ_RENDERING_OGRE_NEXT_VISIBLE OgreNextRenderTexture :
      public virtual BaseRenderTexture<OgreNextRenderTarget>
    {
      /// \brief Constructor
      protected: OgreNextRenderTexture();

      /// \brief Destructor
      public: virtual ~OgreNextRenderTexture();
      ...
      /// \brief Make scene our friend so it can create a ogre_next render
      /// texture
      private: friend class OgreNextScene;
    };

    /// \brief OgreNext.x implementation of the render window class
    class GZ_RENDERING_OGRE_NEXT_VISIBLE OgreNextRenderWindow :
      public virtual BaseRenderWindow<OgreNextRenderTarget>
    {
      /// \brief Constructor
      protected: OgreNextRenderWindow();

      /// \brief Destructor
      public: virtual ~OgreNextRenderWindow();
