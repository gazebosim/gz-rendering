...
#ifndef GZ_RENDERING_OGRE_NEXT_OGRE_NEXTDEPTHCAMERA_HH_
#define GZ_RENDERING_OGRE_NEXT_OGRE_NEXTDEPTHCAMERA_HH_
...
namespace gz
{
  namespace rendering
  {
    ...
    //
    // Forward declaration
    class OgreNextDepthCameraPrivate;

    /// \brief Depth camera used to render depth data into an image buffer
    class GZ_RENDERING_OGRE_NEXT_VISIBLE OgreNextDepthCamera :
      public virtual BaseDepthCamera<OgreNextSensor>,
      public virtual OgreNextObjectInterface
    {
      /// \brief Constructor
      protected: OgreNextDepthCamera();

      /// \brief Destructor
      public: virtual ~OgreNextDepthCamera();
      ...
      private: std::unique_ptr<OgreNextDepthCameraPrivate> dataPtr;
