...
class gz::rendering::OgreNextCOMVisualPrivate
{
  /// \brief Grid materal
...
//////////////////////////////////////////////////
OgreNextCOMVisual::OgreNextCOMVisual()
  : dataPtr(new OgreNextCOMVisualPrivate)
{
}
...
//////////////////////////////////////////////////
void OgreNextCOMVisual::PreRender()
{
...
//////////////////////////////////////////////////
void OgreNextCOMVisual::Init()
{
  BaseCOMVisual::Init();
}

//////////////////////////////////////////////////
void OgreNextCOMVisual::Destroy()
{
...
//////////////////////////////////////////////////
void OgreNextCOMVisual::CreateVisual()
{
  if (!this->dataPtr->crossLines)
  {
    this->dataPtr->crossLines.reset(
...
//////////////////////////////////////////////////
void OgreNextCOMVisual::SetMaterial(MaterialPtr _material, bool _unique)
{
...
//////////////////////////////////////////////////
void OgreNextCOMVisual::SetMaterialImpl(OgreNextMaterialPtr _material)
{
...
//////////////////////////////////////////////////
MaterialPtr OgreNextCOMVisual::Material() const
{
  return this->dataPtr->material;
}

//////////////////////////////////////////////////
VisualPtr OgreNextCOMVisual::SphereVisual() const
{
