...
//////////////////////////////////////////////////
OgreNextRenderTargetMaterial::OgreNextRenderTargetMaterial(
  ...
  scene(_scene), renderCamera(_renderCamera), material(_material)
{
  ...
  this->schemeName = "__gz__rendering__OgreNextRenderTargetMaterial";
...
//////////////////////////////////////////////////
void OgreNextRenderTargetMaterial::cameraPreRenderScene(
    Ogre::Camera * /*_evt*/)
{
...
//////////////////////////////////////////////////
void OgreNextRenderTargetMaterial::cameraPostRenderScene(
    Ogre::Camera * /*_evt*/)
{
...
Ogre::Technique *OgreNextRenderTargetMaterial::handleSchemeNotFound(
