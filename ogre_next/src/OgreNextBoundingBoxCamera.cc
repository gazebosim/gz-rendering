...
#include "OgreNextBoundingBoxMaterialSwitcher.hh"

using namespace gz;
using namespace rendering;

class gz::rendering::OgreNextBoundingBoxCameraPrivate
{
  ...
  public: std::unique_ptr<OgreNextBoundingBoxMaterialSwitcher> materialSwitcher;
  ...
  public: OgreNextRenderTexturePtr dummyTexture {nullptr};
...
/////////////////////////////////////////////////
void OgreNextBoundingBoxCameraPrivate::AddToViewportLines(
    const math::Vector4d &_bounds, const math::Vector2d &_p0,
...
OgreNextBoundingBoxCameraPrivate::ClipToViewPort(const math::Vector4d &_bounds,
...
/////////////////////////////////////////////////
int OgreNextBoundingBoxCameraPrivate::LocationRelativeToViewPort(
...
/////////////////////////////////////////////////
OgreNextBoundingBoxCamera::OgreNextBoundingBoxCamera() :
  dataPtr(std::make_unique<OgreNextBoundingBoxCameraPrivate>())
{
}
...
/////////////////////////////////////////////////
void OgreNextBoundingBoxCamera::Init()
{
  BaseCamera::Init();
  this->CreateCamera();
  ...
  this->dataPtr->materialSwitcher = std::make_unique<
    OgreNextBoundingBoxMaterialSwitcher>(this->scene);
}

/////////////////////////////////////////////////
void OgreNextBoundingBoxCamera::CreateCamera()
{
...
/////////////////////////////////////////////////
void OgreNextBoundingBoxCamera::Destroy()
{
...
/////////////////////////////////////////////////
void OgreNextBoundingBoxCamera::PreRender()
{
...
/////////////////////////////////////////////////
void OgreNextBoundingBoxCamera::CreateBoundingBoxTexture()
{
...
/////////////////////////////////////////////////
void OgreNextBoundingBoxCamera::Render()
{
...
/////////////////////////////////////////////////
void OgreNextBoundingBoxCamera::PostRender()
{
...
/////////////////////////////////////////////////
void OgreNextBoundingBoxCamera::MarkVisibleBoxes()
{
...
/////////////////////////////////////////////////
void OgreNextBoundingBoxCameraPrivate::MeshVertices(
    ...
    for (const auto &subMesh : subMeshes)
    {
      ...
      if (!vaos.empty())
      {
        ...
        for (size_t i = 0; i < subMeshVerticiesNum; ++i)
        {
          ...
          _vertices.push_back(OgreNextConversions::Convert(vec));
...
/////////////////////////////////////////////////
void OgreNextBoundingBoxCamera::MergeMultiLinksModels3D()
{
...
/////////////////////////////////////////////////
void OgreNextBoundingBoxCamera::MergeMultiLinksModels2D()
{
...
/////////////////////////////////////////////////
BoundingBox OgreNextBoundingBoxCameraPrivate::MergeBoxes2D(
        const std::vector<std::shared_ptr<BoundingBox>> &_boxes)
{
  if (_boxes.size() == 1)
    return *_boxes[0];
...
/////////////////////////////////////////////////
void OgreNextBoundingBoxCamera::BoundingBoxes3D()
{
  ...
  while (itor.hasMoreElements())
  {
    ...
    // Convert to gz::math
    box->SetCenter(OgreNextConversions::Convert(viewPosition));
    box->SetSize(OgreNextConversions::Convert(size));

    // Compute the rotation of the box from its world rotation & view matrix
    auto worldCameraRotation = OgreNextConversions::Convert(
      viewMatrix.extractQuaternion());
    auto bodyWorldRotation = OgreNextConversions::Convert(orientation);
...
/////////////////////////////////////////////////
void OgreNextBoundingBoxCamera::VisibleBoundingBoxes()
{
...
/////////////////////////////////////////////////
void OgreNextBoundingBoxCamera::FullBoundingBoxes()
{
...
/////////////////////////////////////////////////
void OgreNextBoundingBoxCamera::MeshMinimalBox(
...
/////////////////////////////////////////////////
void OgreNextBoundingBoxCamera::DrawLine(unsigned char *_data,
...
/////////////////////////////////////////////////
void OgreNextBoundingBoxCamera::DrawBoundingBox(unsigned char *_data,
...
/////////////////////////////////////////////////
void OgreNextBoundingBoxCamera::ConvertToScreenCoord(
...
/////////////////////////////////////////////////
const std::vector<BoundingBox> &OgreNextBoundingBoxCamera::BoundingBoxData()
    const
{
...
common::ConnectionPtr
  OgreNextBoundingBoxCamera::ConnectNewBoundingBoxes(
...
/////////////////////////////////////////////////
void OgreNextBoundingBoxCamera::CreateRenderTexture()
{
...
/////////////////////////////////////////////////
RenderTargetPtr OgreNextBoundingBoxCamera::RenderTarget() const
{
  return this->dataPtr->dummyTexture;
}

/////////////////////////////////////////////////
void OgreNextBoundingBoxCamera::SetBoundingBoxType(BoundingBoxType _type)
{
  this->dataPtr->type = _type;
}

/////////////////////////////////////////////////
BoundingBoxType OgreNextBoundingBoxCamera::Type() const
{
  return this->dataPtr->type;
}

/////////////////////////////////////////////////
math::Matrix4d OgreNextBoundingBoxCamera::ProjectionMatrix() const
{
...
/////////////////////////////////////////////////
void OgreNextBoundingBoxCamera::SetProjectionMatrix(
