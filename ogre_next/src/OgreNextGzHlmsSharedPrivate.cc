...
namespace gz
{
  ...
  {
    /////////////////////////////////////////////////
    OgreNextGzHlmsShared::~OgreNextGzHlmsShared()
    {
      if (!this->vaoManager)
        return;
    ...
    /////////////////////////////////////////////////
    void OgreNextGzHlmsShared::BindObjectDataBuffer(
    ...
    /////////////////////////////////////////////////
    float *OgreNextGzHlmsShared::MapObjectDataBufferFor(
    ...
    /////////////////////////////////////////////////
    void OgreNextGzHlmsShared::UnmapObjectDataBuffer()
    {
      if (this->currPerObjectDataBuffer)
      {
