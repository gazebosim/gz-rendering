 ...
 *
 */
#ifndef GZ_RENDERING_OGRE_NEXT_OGRE_NEXTGZHLMSUNLITPRIVATE_HH_
#define GZ_RENDERING_OGRE_NEXT_OGRE_NEXTGZHLMSUNLITPRIVATE_HH_

#include "gz/rendering/config.hh"
#include "gz/rendering/ogre_next/Export.hh"

#include "OgreNextGzHlmsSphericalClipMinDistance.hh"
#include "OgreNextGzHlmsSharedPrivate.hh"
...
namespace Ogre
{
  ...
  /// files in ogre_next/src/media/Hlms/Gz registered
  ///
  ...
  /// next render)
  class GZ_RENDERING_OGRE_NEXT_HIDDEN OgreNextGzHlmsUnlit final
    : public HlmsUnlit,
      public HlmsListener,
      public gz::rendering::OgreNextGzHlmsShared
  {
    /// \brief Constructor. Asks for modular listeners so we can add
    /// them in the proper order
    public: OgreNextGzHlmsUnlit(Archive *dataFolder, ArchiveVec *libraryFolders,
                              gz::rendering::
                              OgreNextGzHlmsSphericalClipMinDistance
                              *_sphericalClipMinDistance);

    /// \brief Destructor. Virtual to silence warnings
    public: virtual ~OgreNextGzHlmsUnlit() override = default;
    ...
    protected: using HlmsUnlit::setupRootLayout;
    ...
    /// OgreNextGzHlmsUnlit to be bound again
