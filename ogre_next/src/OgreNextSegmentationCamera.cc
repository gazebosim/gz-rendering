...
#include "OgreNextSegmentationMaterialSwitcher.hh"

/// \brief Private data for the OgreNextSegmentationCamera class
class gz::rendering::OgreNextSegmentationCameraPrivate
{
  ...
  public: std::unique_ptr<OgreNextSegmentationMaterialSwitcher>
...
/////////////////////////////////////////////////
OgreNextSegmentationCamera::OgreNextSegmentationCamera() :
  dataPtr(new OgreNextSegmentationCameraPrivate())
{
}
...
/////////////////////////////////////////////////
void OgreNextSegmentationCamera::Init()
{
  BaseCamera::Init();
  ...
  this->dataPtr->materialSwitcher.reset(
      new OgreNextSegmentationMaterialSwitcher(this->scene, this));
}

/////////////////////////////////////////////////
void OgreNextSegmentationCamera::Destroy()
{
...
/////////////////////////////////////////////////
void OgreNextSegmentationCamera::PreRender()
{
...
/////////////////////////////////////////////////
void OgreNextSegmentationCamera::CreateCamera()
{
...
/////////////////////////////////////////////////
void OgreNextSegmentationCamera::CreateSegmentationTexture()
{
  ...
  auto backgroundColor_ = OgreNextConversions::Convert(
...
/////////////////////////////////////////////////
void OgreNextSegmentationCamera::PostRender()
{
...
gz::common::ConnectionPtr
  OgreNextSegmentationCamera::ConnectNewSegmentationFrame(
...
/////////////////////////////////////////////////
void OgreNextSegmentationCamera::Render()
{
...
/////////////////////////////////////////////////
RenderTargetPtr OgreNextSegmentationCamera::RenderTarget() const
{
  return this->dataPtr->segmentationTexture;
}

/////////////////////////////////////////////////
void OgreNextSegmentationCamera::CreateRenderTexture()
{
...
/////////////////////////////////////////////////
void OgreNextSegmentationCamera::SetBackgroundLabel(int _label)
{
...
/////////////////////////////////////////////////
void OgreNextSegmentationCamera::LabelMapFromColoredBuffer(
...
//////////////////////////////////////////////////
Ogre::Camera *OgreNextSegmentationCamera::OgreCamera() const
{
  return this->ogreCamera;
}

/////////////////////////////////////////////////
math::Matrix4d OgreNextSegmentationCamera::ProjectionMatrix() const
{
  return OgreNextConversions::Convert(this->ogreCamera->getProjectionMatrix());
}

/////////////////////////////////////////////////
void OgreNextSegmentationCamera::SetProjectionMatrix(
