...
#ifndef GZ_RENDERING_OGRE_NEXT_OGRE_NEXTCAPSULE_HH_
#define GZ_RENDERING_OGRE_NEXT_OGRE_NEXTCAPSULE_HH_
...
namespace gz
{
  namespace rendering
  {
    inline namespace GZ_RENDERING_VERSION_NAMESPACE {
      // Forward declaration
      class OgreNextCapsulePrivate;

      /// \brief Ogre 2.x implementation of a Capsule Geometry.
      class GZ_RENDERING_OGRE_NEXT_VISIBLE OgreNextCapsule
        : public BaseCapsule<OgreNextGeometry>
      {
        /// \brief Constructor
        protected: OgreNextCapsule();

        /// \brief Destructor
        public: virtual ~OgreNextCapsule();
        ...
        private: std::unique_ptr<OgreNextCapsulePrivate> dataPtr;
      };
    }
  }
}
