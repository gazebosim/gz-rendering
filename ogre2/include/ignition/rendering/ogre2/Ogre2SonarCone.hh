...
#ifndef IGNITION_RENDERING_OGRE2_OGRE2SONARCONE_HH_
#define IGNITION_RENDERING_OGRE2_OGRE2SONARCONE_HH_
...
#include "ignition/rendering/base/BaseSonarCone.hh"
...
namespace ignition
{
  namespace rendering
  {
    ...
    //
    // Forward declaration
    class Ogre2SonarPrivate;

    /// \brief Depth camera used to render depth data into an image buffer
    class IGNITION_RENDERING_OGRE2_VISIBLE Ogre2SonarCone :
      public virtual BaseSonarCone<Ogre2Sensor>,
      public virtual Ogre2ObjectInterface
    {
      /// \brief Constructor
      protected: Ogre2SonarCone();

      /// \brief Destructor
      public: virtual ~Ogre2SonarCone();

      /// \brief Initialize the camera  A
      ...
      private: std::unique_ptr<Ogre2SonarPrivate> dataPtr;
