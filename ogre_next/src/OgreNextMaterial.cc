...
/// \brief Private data for the OgreNextMaterial class
class gz::rendering::OgreNextMaterialPrivate
{
  ...
  /// cameras (e.g. sensors) like OgreNextGpuRays,
  /// OgreNextLaserRetroMaterialSwitcher, etc
  ///
...
//////////////////////////////////////////////////
OgreNextMaterial::OgreNextMaterial()
  : dataPtr(std::make_unique<OgreNextMaterialPrivate>())
{
}
...
void OgreNextMaterial::Destroy()
{
  ...
  OgreNextScenePtr s = std::dynamic_pointer_cast<OgreNextScene>(this->Scene());
...
//////////////////////////////////////////////////
math::Color OgreNextMaterial::Diffuse() const
{
  Ogre::Vector3 color =
...
//////////////////////////////////////////////////
void OgreNextMaterial::SetDiffuse(const math::Color &_color)
{
...
//////////////////////////////////////////////////
math::Color OgreNextMaterial::Specular() const
{
  Ogre::Vector3 color =
...
//////////////////////////////////////////////////
void OgreNextMaterial::SetSpecular(const math::Color &_color)
{
...
//////////////////////////////////////////////////
math::Color OgreNextMaterial::Emissive() const
{
  Ogre::Vector3 color =
...
//////////////////////////////////////////////////
void OgreNextMaterial::SetEmissive(const math::Color &_color)
{
...
//////////////////////////////////////////////////
void OgreNextMaterial::SetTransparency(const double _transparency)
{
...
//////////////////////////////////////////////////
void OgreNextMaterial::UpdateTransparency()
{
...
//////////////////////////////////////////////////
void OgreNextMaterial::SetAlphaFromTexture(bool _enabled,
...
//////////////////////////////////////////////////
float OgreNextMaterial::RenderOrder() const
{
...
//////////////////////////////////////////////////
void OgreNextMaterial::SetRenderOrder(const float _renderOrder)
{
...
//////////////////////////////////////////////////
bool OgreNextMaterial::ReceiveShadows() const
{
  return this->ogreDatablock->getReceiveShadows();
}

//////////////////////////////////////////////////
void OgreNextMaterial::SetReceiveShadows(const bool _receiveShadows)
{
  this->ogreDatablock->setReceiveShadows(_receiveShadows);
}

//////////////////////////////////////////////////
bool OgreNextMaterial::HasTexture() const
{
  return !this->textureName.empty();
}

//////////////////////////////////////////////////
std::string OgreNextMaterial::Texture() const
{
  return this->textureName;
}

//////////////////////////////////////////////////
void OgreNextMaterial::SetTexture(const std::string &_name,
...
//////////////////////////////////////////////////
std::shared_ptr<const common::Image> OgreNextMaterial::TextureData() const
{
  return this->dataPtr->textureData;
}

//////////////////////////////////////////////////
void OgreNextMaterial::ClearTexture()
{
  this->textureName = "";
...
//////////////////////////////////////////////////
bool OgreNextMaterial::HasNormalMap() const
{
  return !this->normalMapName.empty();
}

//////////////////////////////////////////////////
std::string OgreNextMaterial::NormalMap() const
{
  return this->normalMapName;
}

//////////////////////////////////////////////////
std::shared_ptr<const common::Image> OgreNextMaterial::NormalMapData() const
{
  return this->dataPtr->normalMapData;
}

//////////////////////////////////////////////////
void OgreNextMaterial::SetNormalMap(const std::string &_name,
  const std::shared_ptr<const common::Image> &_img)
{
  if (_name.empty())
  {
...
//////////////////////////////////////////////////
void OgreNextMaterial::ClearNormalMap()
{
  this->normalMapName = "";
...
//////////////////////////////////////////////////
bool OgreNextMaterial::HasRoughnessMap() const
{
  return !this->roughnessMapName.empty();
}

//////////////////////////////////////////////////
std::string OgreNextMaterial::RoughnessMap() const
{
  return this->roughnessMapName;
}

//////////////////////////////////////////////////
std::shared_ptr<const common::Image> OgreNextMaterial::RoughnessMapData() const
{
  return this->dataPtr->roughnessMapData;
}

//////////////////////////////////////////////////
void OgreNextMaterial::SetRoughnessMap(const std::string &_name,
  const std::shared_ptr<const common::Image> &_img)
{
  if (_name.empty())
  {
...
//////////////////////////////////////////////////
void OgreNextMaterial::ClearRoughnessMap()
{
...
//////////////////////////////////////////////////
bool OgreNextMaterial::HasMetalnessMap() const
{
  return !this->metalnessMapName.empty();
}

//////////////////////////////////////////////////
std::string OgreNextMaterial::MetalnessMap() const
{
  return this->metalnessMapName;
}

//////////////////////////////////////////////////
std::shared_ptr<const common::Image> OgreNextMaterial::MetalnessMapData() const
{
  return this->dataPtr->metalnessMapData;
}

//////////////////////////////////////////////////
void OgreNextMaterial::SetMetalnessMap(const std::string &_name,
  const std::shared_ptr<const common::Image> &_img)
{
  if (_name.empty())
  {
...
//////////////////////////////////////////////////
void OgreNextMaterial::ClearMetalnessMap()
{
...
//////////////////////////////////////////////////
bool OgreNextMaterial::HasEnvironmentMap() const
{
  return !this->environmentMapName.empty();
}

//////////////////////////////////////////////////
std::string OgreNextMaterial::EnvironmentMap() const
{
  return this->environmentMapName;
}

//////////////////////////////////////////////////
std::shared_ptr<const common::Image> OgreNextMaterial::EnvironmentMapData()
    const
{
...
//////////////////////////////////////////////////
void OgreNextMaterial::SetEnvironmentMap(const std::string &_name,
  const std::shared_ptr<const common::Image> &_img)
{
  if (_name.empty())
  {
...
//////////////////////////////////////////////////
void OgreNextMaterial::ClearEnvironmentMap()
{
...
//////////////////////////////////////////////////
bool OgreNextMaterial::HasEmissiveMap() const
{
  return !this->emissiveMapName.empty();
}

//////////////////////////////////////////////////
std::string OgreNextMaterial::EmissiveMap() const
{
  return this->emissiveMapName;
}

//////////////////////////////////////////////////
std::shared_ptr<const common::Image> OgreNextMaterial::EmissiveMapData() const
{
  return this->dataPtr->emissiveMapData;
}

//////////////////////////////////////////////////
void OgreNextMaterial::SetEmissiveMap(const std::string &_name,
  const std::shared_ptr<const common::Image> &_img)
{
  if (_name.empty())
  {
...
//////////////////////////////////////////////////
void OgreNextMaterial::ClearEmissiveMap()
{
...
//////////////////////////////////////////////////
bool OgreNextMaterial::HasLightMap() const
{
  return !this->lightMapName.empty();
}

//////////////////////////////////////////////////
std::string OgreNextMaterial::LightMap() const
{
  return this->lightMapName;
}

//////////////////////////////////////////////////
unsigned int OgreNextMaterial::LightMapTexCoordSet() const
{
  return this->lightMapUvSet;
}

//////////////////////////////////////////////////
void OgreNextMaterial::SetLightMap(const std::string &_name,
  const std::shared_ptr<const common::Image> &_img,
  unsigned int _uvSet)
{
  if (_name.empty())
...
//////////////////////////////////////////////////
std::shared_ptr<const common::Image> OgreNextMaterial::LightMapData() const
{
  return this->dataPtr->lightMapData;
}

//////////////////////////////////////////////////
void OgreNextMaterial::ClearLightMap()
{
  this->lightMapName = "";
...
//////////////////////////////////////////////////
void OgreNextMaterial::SetRoughness(const float _roughness)
{
  this->ogreDatablock->setRoughness(_roughness);
}

//////////////////////////////////////////////////
float OgreNextMaterial::Roughness() const
{
  return this->ogreDatablock->getRoughness();
}

//////////////////////////////////////////////////
void OgreNextMaterial::SetMetalness(const float _metalness)
{
  this->ogreDatablock->setMetalness(_metalness);
}

//////////////////////////////////////////////////
float OgreNextMaterial::Metalness() const
{
  return this->ogreDatablock->getMetalness();
}

//////////////////////////////////////////////////
void OgreNextMaterial::PreRender()
{
...
//////////////////////////////////////////////////
void OgreNextMaterial::UpdateShaderParams()
{
...
//////////////////////////////////////////////////
void OgreNextMaterial::UpdateShaderParams(ConstShaderParamsPtr _params,
    Ogre::GpuProgramParametersSharedPtr _ogreParams)
{
  ...
  for (const auto &name_param : *_params)
  {
    ...
    if (!_ogreParams->_findNamedConstantDefinition(name_param.first) &&
        !(OgreNextRenderEngine::Instance()->GraphicsAPI() !=
            GraphicsAPI::OPENGL &&
             ...
             ShaderParam::PARAM_TEXTURE_CUBE == name_param.second.Type())
    {
...
#if (OGRE_NEXT_VERSION_MAJOR > 2)
      //! \todo Implement logic or remove branch
#else
      ...
      if (OgreNextRenderEngine::Instance()->GraphicsAPI() ==
          GraphicsAPI::OPENGL)
      {
...
//////////////////////////////////////////////////
Ogre::MaterialPtr OgreNextMaterial::Material()
{
  if (!this->ogreMaterial)
  {
    ...
    const auto graphicsApi = OgreNextRenderEngine::Instance()->GraphicsAPI();
...
//////////////////////////////////////////////////
Ogre::HlmsPbsDatablock *OgreNextMaterial::Datablock() const
{
  return this->ogreDatablock;
}

//////////////////////////////////////////////////
void OgreNextMaterial::SetTextureMapImpl(const std::string &_texture,
...
//////////////////////////////////////////////////
void OgreNextMaterial::SetTextureMapDataImpl(const std::string& _name,
  const std::shared_ptr<const common::Image> &_img,
  Ogre::PbsTextureTypes _type)
{
  Ogre::Root *root = OgreNextRenderEngine::Instance()->OgreRoot();
...
//////////////////////////////////////////////////////
Ogre::TextureGpu* OgreNextMaterial::Texture(const std::string &_name)
{
  Ogre::Root *root = OgreNextRenderEngine::Instance()->OgreRoot();
  Ogre::TextureGpuManager *textureMgr =
    root->getRenderSystem()->getTextureGpuManager();
...
void OgreNextMaterial::Init()
{
  ...
  if (!this->ogreHlmsPbs)
  {
    gzerr << "Ogre HLMS PBS not ready. Is OgreNext Render Engine initialized?"
           << std::endl;
    return;
  }
...
//////////////////////////////////////////////////
enum MaterialType OgreNextMaterial::Type() const
{
  return MaterialType::MT_PBS;
}

//////////////////////////////////////////////////
bool OgreNextMaterial::DepthCheckEnabled() const
{
...
//////////////////////////////////////////////////
void OgreNextMaterial::SetDepthCheckEnabled(bool _enabled)
{
  Ogre::HlmsMacroblock macroblock(
      *this->ogreDatablock->getMacroblock());
...
//////////////////////////////////////////////////
bool OgreNextMaterial::DepthWriteEnabled() const
{
  const Ogre::HlmsMacroblock *macroblock = this->ogreDatablock->getMacroblock();
...
//////////////////////////////////////////////////
void OgreNextMaterial::SetDepthWriteEnabled(bool _enabled)
{
  Ogre::HlmsMacroblock macroblock(
      *this->ogreDatablock->getMacroblock());
...
//////////////////////////////////////////////////
Ogre::HlmsUnlitDatablock *OgreNextMaterial::UnlitDatablock()
{
  if (!this->ogreUnlitDatablock)
  {
    ...
    if (!ogreHlmsUnlit)
    {
      gzerr << "Ogre HLMS UNLIT not ready. Is OgreNext Render Engine "
...
//////////////////////////////////////////////////
void OgreNextMaterial::FillUnlitDatablock(Ogre::HlmsUnlitDatablock *_datablock)
    const
{
...
//////////////////////////////////////////////////
void OgreNextMaterial::SetVertexShader(const std::string &_path)
{
  if (_path.empty())
    return;
...
//////////////////////////////////////////////////
std::string OgreNextMaterial::VertexShader() const
{
  return this->dataPtr->vertexShaderPath;
}

//////////////////////////////////////////////////
ShaderParamsPtr OgreNextMaterial::VertexShaderParams()
{
  return this->dataPtr->vertexShaderParams;
}

//////////////////////////////////////////////////
void OgreNextMaterial::SetFragmentShader(const std::string &_path)
{
  if (_path.empty())
    return;
  ...
  if (OgreNextRenderEngine::Instance()->GraphicsAPI() == GraphicsAPI::METAL)
  {
...
//////////////////////////////////////////////////
std::string OgreNextMaterial::FragmentShader() const
{
  return this->dataPtr->fragmentShaderPath;
}

//////////////////////////////////////////////////
ShaderParamsPtr OgreNextMaterial::FragmentShaderParams()
{
  return this->dataPtr->fragmentShaderParams;
}

//////////////////////////////////////////////////
void OgreNextMaterialPrivate::PrepareForNormalMapping(
...
//////////////////////////////////////////////////
void OgreNextMaterialPrivate::AllocateMipmaps(Ogre::TextureGpu *_texture)
{
...
//////////////////////////////////////////////////
void OgreNextMaterialPrivate::GenerateMipmaps(Ogre::TextureGpu *_texture)
{
