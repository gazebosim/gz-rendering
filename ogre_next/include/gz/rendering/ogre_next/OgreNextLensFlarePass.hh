 ...
 *
 */
#ifndef GZ_RENDERING_OGRE_NEXT_OGRE_NEXTLENSFLAREPASS_HH_
#define GZ_RENDERING_OGRE_NEXT_OGRE_NEXTLENSFLAREPASS_HH_
...
namespace gz
{
  namespace rendering
  {
    ...
    /// \brief OgreNext Implementation of a Lens Flare render pass.
    class GZ_RENDERING_OGRE_NEXT_VISIBLE OgreNextLensFlarePass :
      public BaseLensFlarePass<OgreNextRenderPass>
    {
      /// \brief Constructor
      public: OgreNextLensFlarePass();

      /// \brief Destructor
      public: ~OgreNextLensFlarePass() override;
      ...
      /// \remark OgreNextLensFlarePass::PreRender must have been called first.
      ...
      private: friend class OgreNextLensFlarePassWorkspaceListenerPrivate;
    };
    }
  }
}
