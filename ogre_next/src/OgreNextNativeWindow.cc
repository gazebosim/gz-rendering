...
class GZ_RENDERING_OGRE_NEXT_HIDDEN gz::rendering::OgreNextNativeWindowPrivate
{
  // clang-format off
  /// \brief The native Ogre window handle
  public: Ogre::Window *window{ nullptr };

  /// \brief The workspace used by OgreNextNativeWindow::Draw
...
//////////////////////////////////////////////////
OgreNextNativeWindow::OgreNextNativeWindow(Ogre::Window *_window) :
  dataPtr(new OgreNextNativeWindowPrivate)
{
...
//////////////////////////////////////////////////
OgreNextNativeWindow::~OgreNextNativeWindow()
{
...
//////////////////////////////////////////////////
void OgreNextNativeWindow::NotifyFocused(bool _focused)
{
  this->dataPtr->window->setFocused(_focused);
}

//////////////////////////////////////////////////
void OgreNextNativeWindow::NotifyVisible(bool _visible)
{
  this->dataPtr->window->_setVisible(_visible);
}

//////////////////////////////////////////////////
void OgreNextNativeWindow::NotifyWindowMovedOrResized()
{
  this->dataPtr->window->windowMovedOrResized();
}

//////////////////////////////////////////////////
void OgreNextNativeWindow::RequestResolution(uint32_t _width, uint32_t _height)
{
  this->dataPtr->window->requestResolution(_width, _height);
}

//////////////////////////////////////////////////
void OgreNextNativeWindow::Draw(CameraPtr _camera)
{
  GZ_PROFILE("Ogre2NativeWindow::Draw");
  OgreNextCamera *camera = dynamic_cast<OgreNextCamera *>(_camera.get());
  ...
  OgreNextRenderTargetPtr renderTarget = camera->renderTexture;

  OgreNextScene *scene = dynamic_cast<OgreNextScene *>(camera->Scene().get());
