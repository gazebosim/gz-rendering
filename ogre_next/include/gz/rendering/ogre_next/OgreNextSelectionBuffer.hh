 ...
 *
*/
#ifndef GZ_RENDERING_OGRE_NEXT_OGRE_NEXTSELECTIONBUFFER_HH_
#define GZ_RENDERING_OGRE_NEXT_OGRE_NEXTSELECTIONBUFFER_HH_
...
namespace gz
{
  namespace rendering
  {
    ...
    //
    // forward declaration
    struct OgreNextSelectionBufferPrivate;
    ...
    class GZ_RENDERING_OGRE_NEXT_VISIBLE OgreNextSelectionBuffer
    {
      /// \brief Constructor
      ...
      public: OgreNextSelectionBuffer(const std::string &_cameraName,
                  OgreNextScenePtr _scene, unsigned int _width,
                  unsigned int _height);

      /// \brief Destructor
      public: ~OgreNextSelectionBuffer();
      ...
      private: std::unique_ptr<OgreNextSelectionBufferPrivate> dataPtr;
    };
    }
  }
}
