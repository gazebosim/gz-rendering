...
//////////////////////////////////////////////////
OgreNextParticleNoiseListener::OgreNextParticleNoiseListener(
    OgreNextScenePtr _scene, Ogre::MaterialPtr _ogreMaterial)
{
  this->scene = _scene;
...
//////////////////////////////////////////////////
void OgreNextParticleNoiseListener::cameraPreRenderScene(
    Ogre::Camera * _cam)
{
  ...
  while (itor.hasMoreElements())
  {
    ...
    if (_cam->isVisible(box))
    {
      ...
      if (!userAny.isEmpty() && userAny.getType() == typeid(unsigned int))
      {
        ...
        OgreNextParticleEmitterPtr emitterPtr =
          std::dynamic_pointer_cast<OgreNextParticleEmitter>(result);
        if (emitterPtr)
...
//////////////////////////////////////////////////
void OgreNextParticleNoiseListener::SetupMaterial(Ogre::Pass *_pass,
