 ...
 *
 */
#include "gz/rendering/ogre_next/OgreNextLensFlarePass.hh"
...
class GZ_RENDERING_OGRE_NEXT_HIDDEN
    OgreNextLensFlarePassWorkspaceListenerPrivate final
      : public Ogre::CompositorWorkspaceListener
{
  public: gz::rendering::OgreNextLensFlarePass &owner;

  /// \brief constructor
  /// \param[in] _scene the scene manager responsible for rendering
  public: explicit OgreNextLensFlarePassWorkspaceListenerPrivate(
        gz::rendering::OgreNextLensFlarePass &_owner) :
    owner(_owner)
  {
  }
...
/// \brief Private data for the OgreNextLensFlarePass class
class gz::rendering::OgreNextLensFlarePass::Implementation
{
  // clang-format off
  ...
  /// \brief See OgreNextLensFlarePassWorkspaceListenerPrivate
  public: OgreNextLensFlarePassWorkspaceListenerPrivate workspaceListener;
...
//////////////////////////////////////////////////
OgreNextLensFlarePass::OgreNextLensFlarePass() :
...
//////////////////////////////////////////////////
void OgreNextLensFlarePass::Destroy()
{
...
//////////////////////////////////////////////////
void OgreNextLensFlarePass::Init(ScenePtr _scene)
{
  this->scene = std::dynamic_pointer_cast<OgreNextScene>(_scene);
  this->dataPtr->rayQuery = _scene->CreateRayQuery();
  this->dataPtr->rayQuery->SetPreferGpu(false);
}

//////////////////////////////////////////////////
void OgreNextLensFlarePass::PreRender(const CameraPtr &_camera)
{
...
//////////////////////////////////////////////////
void OgreNextLensFlarePass::PostRender()
{
  GZ_PROFILE("Ogre2LensFlarePass::PostRender");
  if (!this->enabled || this->light == nullptr)
    return;

  OgreNextWideAngleCameraPtr wideAngleCamera =
    std::dynamic_pointer_cast<OgreNextWideAngleCamera>(
...
//////////////////////////////////////////////////
void OgreNextLensFlarePass::SetScale(const double _scale)
{
  this->dataPtr->scale = _scale;
}

//////////////////////////////////////////////////
double OgreNextLensFlarePass::Scale() const
{
  return this->dataPtr->scale;
}

//////////////////////////////////////////////////
void OgreNextLensFlarePass::SetColor(const math::Vector3d &_color)
{
  this->dataPtr->color = _color;
}

//////////////////////////////////////////////////
const math::Vector3d &OgreNextLensFlarePass::Color() const
{
  return this->dataPtr->color;
}

//////////////////////////////////////////////////
void OgreNextLensFlarePass::SetOcclusionSteps(const uint32_t _occlusionSteps)
{
  this->dataPtr->occlusionSteps = static_cast<double>(_occlusionSteps);
}

//////////////////////////////////////////////////
uint32_t OgreNextLensFlarePass::OcclusionSteps() const
{
  return static_cast<uint32_t>(this->dataPtr->occlusionSteps);
}

//////////////////////////////////////////////////
void OgreNextLensFlarePass::WorkspaceAdded(
...
//////////////////////////////////////////////////
void OgreNextLensFlarePass::WorkspaceRemoved(
    Ogre::CompositorWorkspace *_workspace)
{
...
//////////////////////////////////////////////////
double OgreNextLensFlarePass::OcclusionScale(const math::Vector3d &_imgPos,
                                          uint32_t _faceIdx)
{
...
//////////////////////////////////////////////////
void OgreNextLensFlarePassWorkspaceListenerPrivate::passPreExecute(
  Ogre::CompositorPass *_pass)
{
  ...
  const Vector4 pos =
    viewProj *
    Vector4(OgreNextConversions::Convert(this->owner.dataPtr->lightWorldPos));
  ...
  if (lightPos.z >= 0.0)
  {
    ...
    lensFlareScale = this->owner.OcclusionScale(
      OgreNextConversions::Convert(lightPos), currentFaceIdx);
  }
  ...
  psParams->setNamedConstant(
    "color", OgreNextConversions::Convert(this->owner.dataPtr->color));
...
GZ_RENDERING_REGISTER_RENDER_PASS(OgreNextLensFlarePass, LensFlarePass)
