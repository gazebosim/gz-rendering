...
bool g_clear = false;
ir::MapVisualPtr g_map;
bool g_mapVisualUpdateDirty = false;
...
void updateMapVisual()
{
  ...
  if (g_mapVisualUpdateDirty)
  {
    //g_map->Update();
    g_mapVisualUpdateDirty = false;
    g_clear = false;
...
//////////////////////////////////////////////////
void initMapVisual(ir::MapVisualPtr _map)
{
  g_map = _map;
}
...
void run(std::vector<ir::CameraPtr> _cameras,
        std::vector<ir::MapVisualPtr> _nodes)
{
  std::cout << "5\n";
  if (_cameras.empty())
  {
