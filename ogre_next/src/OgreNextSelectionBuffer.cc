...
#include "gz/rendering/ogre_next/OgreNextMaterialSwitcher.hh"
...
class gz::rendering::OgreNextSelectionBufferPrivate
{
  ...
  public: std::unique_ptr<OgreNextMaterialSwitcher> materialSwitcher;

  /// \brief Ogre scene manager
  public: OgreNextScenePtr scene;
...
/////////////////////////////////////////////////
OgreNextSelectionBuffer::OgreNextSelectionBuffer(const std::string &_cameraName,
    OgreNextScenePtr _scene, unsigned int _width, unsigned int _height):
    dataPtr(new OgreNextSelectionBufferPrivate)
{
  ...
  this->dataPtr->materialSwitcher.reset(
      new OgreNextMaterialSwitcher(this->dataPtr->scene));
  this->CreateRTTBuffer();
}

/////////////////////////////////////////////////
OgreNextSelectionBuffer::~OgreNextSelectionBuffer()
{
...
/////////////////////////////////////////////////
void OgreNextSelectionBuffer::Update()
{
...
/////////////////////////////////////////////////
void OgreNextSelectionBuffer::DeleteRTTBuffer()
{
...
/////////////////////////////////////////////////
void OgreNextSelectionBuffer::CreateRTTBuffer()
{
...
/////////////////////////////////////////////////
void OgreNextSelectionBuffer::SetDimensions(
...
/////////////////////////////////////////////////
Ogre::MovableObject *OgreNextSelectionBuffer::OnSelectionClick(int _x, int _y)
{
...
/////////////////////////////////////////////////
bool OgreNextSelectionBuffer::ExecuteQuery(int _x, int _y,
    Ogre::MovableObject *&_obj, math::Vector3d &_point)
{
  ...
  auto rot = OgreNextConversions::Convert(
      this->dataPtr->camera->getParentSceneNode()->_getDerivedOrientation());
  auto pos = OgreNextConversions::Convert(
    ...
    if (collection.empty())
    {
      ...
      for (auto h : heightmaps)
      {
        ...
        if (heightmap)
        {
          ...
          {
            _obj = std::dynamic_pointer_cast<OgreNextHeightmap>(
