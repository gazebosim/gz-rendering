...
class OgreNextThermalCameraMaterialSwitcher : public Ogre::Camera::Listener
{
  /// \brief constructor
  /// \param[in] _scene the scene manager responsible for rendering
  /// \param[in] _name the name of the thermal camera
  public: explicit OgreNextThermalCameraMaterialSwitcher(
      OgreNextScenePtr _scene,
      const std::string & _name);

  /// \brief destructor
  public: ~OgreNextThermalCameraMaterialSwitcher() = default;
...
/// \internal
/// \brief Private data for the OgreNextThermalCamera class
class gz::rendering::OgreNextThermalCameraPrivate
{
  ...
  public: std::unique_ptr<OgreNextThermalCameraMaterialSwitcher>
...
//////////////////////////////////////////////////
OgreNextThermalCameraMaterialSwitcher::OgreNextThermalCameraMaterialSwitcher(
    OgreNextScenePtr _scene, const std::string & _name) : name(_name)
{
  this->scene = _scene;
...
//////////////////////////////////////////////////
void OgreNextThermalCameraMaterialSwitcher::SetFormat(PixelFormat _format)
{
  this->format = _format;
...
//////////////////////////////////////////////////
void OgreNextThermalCameraMaterialSwitcher::SetLinearResolution(
    double _resolution)
{
  this->resolution = _resolution;
}
//////////////////////////////////////////////////
void OgreNextThermalCameraMaterialSwitcher::cameraPreRenderScene(
    Ogre::Camera * /*_cam*/)
{
...
//////////////////////////////////////////////////
void OgreNextThermalCameraMaterialSwitcher::cameraPostRenderScene(
    Ogre::Camera * /*_cam*/)
{
...
//////////////////////////////////////////////////
OgreNextThermalCamera::OgreNextThermalCamera()
  : dataPtr(new OgreNextThermalCameraPrivate())
{
...
//////////////////////////////////////////////////
void OgreNextThermalCamera::Init()
{
...
//////////////////////////////////////////////////
void OgreNextThermalCamera::Destroy()
{
...
//////////////////////////////////////////////////
void OgreNextThermalCamera::CreateCamera()
{
...
/////////////////////////////////////////////////
void OgreNextThermalCamera::CreateRenderTexture()
{
...
/////////////////////////////////////////////////////////
void OgreNextThermalCamera::CreateThermalTexture()
{
  ...
  for (const auto &c : channels)
  {
    ...
    {
      this->dataPtr->thermalMaterialSwitcher.reset(
          new OgreNextThermalCameraMaterialSwitcher(this->scene, this->Name()));
...
//////////////////////////////////////////////////
void OgreNextThermalCamera::Render()
{
...
//////////////////////////////////////////////////
void OgreNextThermalCamera::PreRender()
{
...
//////////////////////////////////////////////////
void OgreNextThermalCamera::PostRender()
{
...
//////////////////////////////////////////////////
common::ConnectionPtr OgreNextThermalCamera::ConnectNewThermalFrame(
...
//////////////////////////////////////////////////
RenderTargetPtr OgreNextThermalCamera::RenderTarget() const
{
  return this->dataPtr->thermalTexture;
}

//////////////////////////////////////////////////
Ogre::Camera *OgreNextThermalCamera::OgreCamera() const
{
  return this->ogreCamera;
}

/////////////////////////////////////////////////
math::Matrix4d OgreNextThermalCamera::ProjectionMatrix() const
{
  return OgreNextConversions::Convert(this->ogreCamera->getProjectionMatrix());
}

/////////////////////////////////////////////////
void OgreNextThermalCamera::SetProjectionMatrix(const math::Matrix4d &_matrix)
{
