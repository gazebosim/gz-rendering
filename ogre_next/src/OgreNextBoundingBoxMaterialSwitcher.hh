...
#ifndef GZ_RENDERING_OGRE_NEXT_OGRE_NEXTBBOXMATERIALSWITCHER_HH_
#define GZ_RENDERING_OGRE_NEXT_OGRE_NEXTBBOXMATERIALSWITCHER_HH_
...
class OgreNextBoundingBoxMaterialSwitcher : public Ogre::Camera::Listener
{
  /// \brief Constructor
  public: explicit OgreNextBoundingBoxMaterialSwitcher(OgreNextScenePtr _scene);

  /// \brief Destructor
  public: ~OgreNextBoundingBoxMaterialSwitcher();
  ...
  /// \brief OgreNext Scene
  private: OgreNextScenePtr scene;

  friend class OgreNextBoundingBoxCamera;
};
}
}  // namespace rendering
}  // namespace gz
