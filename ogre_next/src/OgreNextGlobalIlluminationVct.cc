...
/// \brief Private data for the OgreNextGlobalIlluminationVct class
class gz::rendering::OgreNextGlobalIlluminationVctPrivate
{
  // clang-format off
...
//////////////////////////////////////////////////
OgreNextGlobalIlluminationVct::OgreNextGlobalIlluminationVct() :
  dataPtr(new OgreNextGlobalIlluminationVctPrivate)
{
}
...
//////////////////////////////////////////////////
void OgreNextGlobalIlluminationVct::Init()
{
  OgreNextObject::Init();
...
//////////////////////////////////////////////////
void OgreNextGlobalIlluminationVct::Destroy()
{
  OgreNextObject::Destroy();
...
//////////////////////////////////////////////////
void OgreNextGlobalIlluminationVct::SetResolution(const uint32_t _resolution[3])
{
  for (int i = 0; i < 3; ++i)
  {
...
//////////////////////////////////////////////////
const uint32_t *OgreNextGlobalIlluminationVct::Resolution() const
{
  return this->dataPtr->resolution;
}

//////////////////////////////////////////////////
void OgreNextGlobalIlluminationVct::SetOctantCount(const uint32_t _octants[3])
{
  for (int i = 0; i < 3; ++i)
  {
...
//////////////////////////////////////////////////
const uint32_t *OgreNextGlobalIlluminationVct::OctantCount() const
{
  return this->dataPtr->octants;
}

//////////////////////////////////////////////////
void OgreNextGlobalIlluminationVct::SetBounceCount(uint32_t _bounceCount)
{
...
//////////////////////////////////////////////////
uint32_t OgreNextGlobalIlluminationVct::BounceCount() const
{
  return this->dataPtr->bounceCount;
}

//////////////////////////////////////////////////
void OgreNextGlobalIlluminationVct::SetParticipatingVisuals(uint32_t _mask)
{
  this->dataPtr->participatingVisuals = _mask;
}

//////////////////////////////////////////////////
uint32_t OgreNextGlobalIlluminationVct::ParticipatingVisuals() const
{
  return this->dataPtr->participatingVisuals;
}

//////////////////////////////////////////////////
void OgreNextGlobalIlluminationVct::SetHighQuality(bool _highQuality)
{
  if (this->Enabled())
  {
...
//////////////////////////////////////////////////
bool OgreNextGlobalIlluminationVct::HighQuality() const
{
  return this->dataPtr->highQuality;
}

//////////////////////////////////////////////////
void OgreNextGlobalIlluminationVct::SetAnisotropic(bool _anisotropic)
{
...
//////////////////////////////////////////////////
bool OgreNextGlobalIlluminationVct::Anisotropic() const
{
  return this->dataPtr->anisotropic;
}

//////////////////////////////////////////////////
void OgreNextGlobalIlluminationVct::SetThinWallCounter(float _thinWallCounter)
{
  this->dataPtr->thinWallCounter = _thinWallCounter;
}

//////////////////////////////////////////////////
float OgreNextGlobalIlluminationVct::ThinWallCounter() const
{
  return this->dataPtr->thinWallCounter;
}

//////////////////////////////////////////////////
void OgreNextGlobalIlluminationVct::SetConserveMemory(bool _conserveMemory)
{
...
//////////////////////////////////////////////////
bool OgreNextGlobalIlluminationVct::ConserveMemory() const
{
  return this->dataPtr->conserveMemory;
}

//////////////////////////////////////////////////
void OgreNextGlobalIlluminationVct::Build()
{
...
//////////////////////////////////////////////////
void OgreNextGlobalIlluminationVct::UpdateLighting()
{
  this->LightingChanged();
}

//////////////////////////////////////////////////
void OgreNextGlobalIlluminationVct::UpdateCamera()
{
}

//////////////////////////////////////////////////
void OgreNextGlobalIlluminationVct::SetEnabled(bool _enabled)
{
  Ogre::HlmsPbs *hlmsPbs = this->HlmsPbs();
  if (_enabled)
  {
...
//////////////////////////////////////////////////
bool OgreNextGlobalIlluminationVct::Enabled() const
{
  if (this->dataPtr->vctLighting == nullptr)
    return false;
...
//////////////////////////////////////////////////
void OgreNextGlobalIlluminationVct::SetDebugVisualization(
...
OgreNextGlobalIlluminationVct::DebugVisualization() const
{
  return this->dataPtr->debugVisualizationMode;
}

//////////////////////////////////////////////////
void OgreNextGlobalIlluminationVct::LightingChanged()
{
...
//////////////////////////////////////////////////
Ogre::HlmsPbs *OgreNextGlobalIlluminationVct::HlmsPbs() const
{
  Ogre::Root *ogreRoot = OgreNextRenderEngine::Instance()->OgreRoot();
...
//////////////////////////////////////////////////
void OgreNextGlobalIlluminationVct::SyncModeVisualizationMode()
{
  if (this->dataPtr->vctLighting)
  {
