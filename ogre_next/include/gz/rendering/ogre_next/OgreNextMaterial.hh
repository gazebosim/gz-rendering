 ...
 *
 */
#ifndef GZ_RENDERING_OGRE_NEXT_OGRE_NEXTMATERIAL_HH_
#define GZ_RENDERING_OGRE_NEXT_OGRE_NEXTMATERIAL_HH_
...
namespace gz
{
  namespace rendering
  {
    ...
    //
    // forward declaration
    class OgreNextMaterialPrivate;

    /// \brief Ogre 2.x implementation of the material class
    class GZ_RENDERING_OGRE_NEXT_VISIBLE OgreNextMaterial :
      public BaseMaterial<OgreNextObject>
    {
      /// \brief Constructor
      protected: OgreNextMaterial();

      /// \brief Destructor
      public: virtual ~OgreNextMaterial();
      ...
      private: std::unique_ptr<OgreNextMaterialPrivate> dataPtr;
