...
class OgreNextProjectorCameraListener: public Ogre::Camera::Listener
{
  /// \brief Constructor
  /// \param[in] _decal Pointer to the ogre decal (projected texture)
  public: OgreNextProjectorCameraListener(Ogre::Decal *_decal);
...
/// \brief Private data for the OgreNextProjector class
class gz::rendering::OgreNextProjector::Implementation
{
  ...
  public: std::unique_ptr<OgreNextProjectorCameraListener> listener;
};

/////////////////////////////////////////////////
OgreNextProjector::OgreNextProjector()
...
/////////////////////////////////////////////////
void OgreNextProjector::PreRender()
{
...
/////////////////////////////////////////////////
void OgreNextProjector::UpdateCameraListener()
{
  ...
  {
    this->dataPtr->listener = std::make_unique<OgreNextProjectorCameraListener>(
        this->dataPtr->decal);
  }
  ...
  for (unsigned int i = 0; i < this->scene->SensorCount(); ++i)
  {
    ...
    else
    {
      ...
      // RGBD cameras)
      OgreNextDepthCameraPtr depthCamera =
          std::dynamic_pointer_cast<OgreNextDepthCamera>(sensor);
      if (depthCamera)
      {
...
/////////////////////////////////////////////////
void OgreNextProjector::CreateProjector()
{
  ...
  // ogre_next uses screen space decal. Unfortunately this is different from
...
/////////////////////////////////////////////////
void OgreNextProjector::SetEnabled(bool _enabled)
{
...
//////////////////////////////////////////////////
void OgreNextProjectorCameraListener::SetVisibilityFlags(uint32_t _flags)
{
  this->visibilityFlags = _flags;
}

//////////////////////////////////////////////////
OgreNextProjectorCameraListener::OgreNextProjectorCameraListener(
  Ogre::Decal *_decal)
{
  this->decal = _decal;
...
//////////////////////////////////////////////////
void OgreNextProjectorCameraListener::cameraPreRenderScene(
    Ogre::Camera *_cam)
{
...
//////////////////////////////////////////////////
void OgreNextProjectorCameraListener::cameraPostRenderScene(
    Ogre::Camera * /*_cam*/)
{
