...
class gz::rendering::OgreNextDynamicRenderablePrivate
{
  ...
  public: OgreNextMaterialPtr material;
...
//////////////////////////////////////////////////
OgreNextDynamicRenderable::OgreNextDynamicRenderable(
    ScenePtr _scene)
    : dataPtr(new OgreNextDynamicRenderablePrivate)
{
  this->dataPtr->scene = _scene;

  OgreNextScenePtr s =
      std::dynamic_pointer_cast<OgreNextScene>(this->dataPtr->scene);
...
//////////////////////////////////////////////////
void OgreNextDynamicRenderable::Destroy()
{
...
//////////////////////////////////////////////////
void OgreNextDynamicRenderable::DestroyBuffer()
{
...
//////////////////////////////////////////////////
Ogre::MovableObject *OgreNextDynamicRenderable::OgreObject() const
{
  return this->dataPtr->ogreItem;
}

//////////////////////////////////////////////////
void OgreNextDynamicRenderable::Update()
{
  this->UpdateBuffer();
}

//////////////////////////////////////////////////
void OgreNextDynamicRenderable::CreateDynamicMesh()
{
  if (this->dataPtr->ogreItem)
    return;
  ...
  // this creates the ogre_next dynamic geometry buffer
  this->UpdateBuffer();
...
//////////////////////////////////////////////////
void OgreNextDynamicRenderable::UpdateBuffer()
{
  ...
  for (unsigned int i = 0; i < vertexCount; ++i)
  {
    ...
    Ogre::Vector3 v = OgreNextConversions::Convert(this->dataPtr->vertices[i]);
    vertices[idx] = v.x;
    vertices[idx+1] = v.y;
    vertices[idx+2] = v.z;
...
//////////////////////////////////////////////////
void OgreNextDynamicRenderable::SetOperationType(MarkerType _opType)
{
  switch (_opType)
  {
    case MT_POINTS:
...
//////////////////////////////////////////////////
MarkerType OgreNextDynamicRenderable::OperationType() const
{
  MarkerType opType;
...
/////////////////////////////////////////////////
void OgreNextDynamicRenderable::AddPoint(const math::Vector3d &_pt,
...
/////////////////////////////////////////////////
void OgreNextDynamicRenderable::AddPoint(double _x, double _y, double _z,
                                      const math::Color &_color)
{
...
/////////////////////////////////////////////////
void OgreNextDynamicRenderable::SetPoint(unsigned int _index,
...
/////////////////////////////////////////////////
void OgreNextDynamicRenderable::SetColor(unsigned int _index,
                                      const math::Color &_color)
{
...
/////////////////////////////////////////////////
math::Vector3d OgreNextDynamicRenderable::Point(
...
/////////////////////////////////////////////////
unsigned int OgreNextDynamicRenderable::PointCount() const
{
  return this->dataPtr->vertices.size();
}

/////////////////////////////////////////////////
void OgreNextDynamicRenderable::Clear()
{
...
//////////////////////////////////////////////////
void OgreNextDynamicRenderable::SetMaterial(MaterialPtr _material, bool _unique)
{
...
//////////////////////////////////////////////////
void OgreNextDynamicRenderable::GenerateNormals(Ogre::OperationType _opType,
...
//////////////////////////////////////////////////
void OgreNextDynamicRenderable::GenerateColors(Ogre::OperationType _opType,
  const std::vector<math::Vector3d> &_vertices, float *_vbuffer)
{
