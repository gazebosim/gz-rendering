...
namespace Ogre
{
  ...
  OgreNextGzHlmsPbs::OgreNextGzHlmsPbs(
  ...
  /////////////////////////////////////////////////
  uint16 OgreNextGzHlmsPbs::getNumExtraPassTextures(
  ...
  /////////////////////////////////////////////////
  void OgreNextGzHlmsPbs::propertiesMergedPreGenerationStep(
    Hlms *_hlms,  //
  ...
  /////////////////////////////////////////////////
  void OgreNextGzHlmsPbs::preparePassHash(
  ...
  /////////////////////////////////////////////////
  uint32 OgreNextGzHlmsPbs::getPassBufferSize(
  ...
  /////////////////////////////////////////////////
  float *OgreNextGzHlmsPbs::preparePassBuffer(
    const Ogre::CompositorShadowNode *_shadowNode, bool _casterPass,
  ...
  /////////////////////////////////////////////////
  void OgreNextGzHlmsPbs::setupRootLayout(RootLayout &_rootLayout,
  ...
  /////////////////////////////////////////////////
  void OgreNextGzHlmsPbs::shaderCacheEntryCreated(
  ...
  /////////////////////////////////////////////////
  void OgreNextGzHlmsPbs::notifyPropertiesMergedPreGenerationStep()
  {
  ...
  /////////////////////////////////////////////////
  void OgreNextGzHlmsPbs::hlmsTypeChanged(bool _casterPass,
  ...
  /////////////////////////////////////////////////
  uint32 OgreNextGzHlmsPbs::fillBuffersForV1(
  ...
  /////////////////////////////////////////////////
  uint32 OgreNextGzHlmsPbs::fillBuffersForV2(
    const HlmsCache *_cache, const QueuedRenderable &_queuedRenderable,
    bool _casterPass, uint32 _lastCacheHash, CommandBuffer *_commandBuffer)
  {
  ...
  /////////////////////////////////////////////////
  void OgreNextGzHlmsPbs::preCommandBufferExecution(
      CommandBuffer *_commandBuffer)
  {
  ...
  /////////////////////////////////////////////////
  void OgreNextGzHlmsPbs::frameEnded()
  {
    HlmsPbs::frameEnded();
  ...
  /////////////////////////////////////////////////
  void OgreNextGzHlmsPbs::GetDefaultPaths(String &_outDataFolderPath,
