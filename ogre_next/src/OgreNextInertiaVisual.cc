...
class gz::rendering::OgreNextInertiaVisualPrivate
{
  ...
  public: std::shared_ptr<OgreNextDynamicRenderable> crossLines = nullptr;
...
//////////////////////////////////////////////////
OgreNextInertiaVisual::OgreNextInertiaVisual()
  : dataPtr(new OgreNextInertiaVisualPrivate)
{
}
...
//////////////////////////////////////////////////
void OgreNextInertiaVisual::PreRender()
{
}

//////////////////////////////////////////////////
void OgreNextInertiaVisual::Init()
{
  BaseInertiaVisual::Init();
}

//////////////////////////////////////////////////
void OgreNextInertiaVisual::Destroy()
{
...
//////////////////////////////////////////////////
void OgreNextInertiaVisual::Load(const gz::math::Pose3d &_pose,
...
//////////////////////////////////////////////////
VisualPtr OgreNextInertiaVisual::BoxVisual() const
{
  return this->dataPtr->boxVis;
}

//////////////////////////////////////////////////
void OgreNextInertiaVisual::SetMaterial(MaterialPtr _material, bool _unique)
{
...
//////////////////////////////////////////////////
void OgreNextInertiaVisual::SetMaterialImpl(OgreNextMaterialPtr _material)
{
...
//////////////////////////////////////////////////
MaterialPtr OgreNextInertiaVisual::Material() const
{
