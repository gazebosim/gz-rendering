...
#ifndef GZ_RENDERING_OGRE_NEXT_OGREMARKER_HH_
#define GZ_RENDERING_OGRE_NEXT_OGREMARKER_HH_
...
namespace gz
{
  namespace rendering
  {
    ...
    //
    // Forward declaration
    class OgreNextMarkerPrivate;

    /// \brief Ogre 2.x implementation of a marker geometry.
    class GZ_RENDERING_OGRE_NEXT_VISIBLE OgreNextMarker
      : public BaseMarker<OgreNextGeometry>
    {
      /// \brief Constructor
      protected: OgreNextMarker();

      /// \brief Destructor
      public: virtual ~OgreNextMarker();
      ...
      private: std::unique_ptr<OgreNextMarkerPrivate> dataPtr;
    };
    }
  }
}
