...
class Ogre2SonarGaussianNoisePass : public Ogre2GaussianNoisePass
{
  /// \brief Constructor
  public: Ogre2SonarGaussianNoisePass() {}

  /// \brief Destructor
  public: virtual ~Ogre2SonarGaussianNoisePass() {}
...
class ignition::rendering::Ogre2SonarPrivate
{
...
//////////////////////////////////////////////////
void Ogre2SonarGaussianNoisePass::PreRender()
{
...
//////////////////////////////////////////////////
void Ogre2SonarGaussianNoisePass::CreateRenderPass()
{
  // This function is similar to Ogre2GaussianNoisePass but duplicated here
  // for Ogre2DepthCamera.
...
//////////////////////////////////////////////////
Ogre2SonarCone::Ogre2SonarCone()
  : dataPtr(new Ogre2SonarPrivate())
{
...
//////////////////////////////////////////////////
void Ogre2SonarCone::CreateCamera()
{
...
/////////////////////////////////////////////////
void Ogre2SonarCone::CreateRenderTexture()
{
...
/////////////////////////////////////////////////////////
void Ogre2SonarCone::CreateDepthTexture()
{
...
//////////////////////////////////////////////////
void Ogre2SonarCone::CreateWorkspaceInstance()
{
  auto engine = Ogre2RenderEngine::Instance();
  auto ogreRoot = engine->OgreRoot();
  Ogre::CompositorManager2 *ogreCompMgr = ogreRoot->getCompositorManager2();
...
//////////////////////////////////////////////////
void Ogre2SonarCone::PostRender()
{
...
//////////////////////////////////////////////////
const float *Ogre2SonarCone::DepthData() const
{
  return this->dataPtr->depthBuffer;
}

//////////////////////////////////////////////////
ignition::common::ConnectionPtr Ogre2SonarCone::ConnectNewDepthFrame(
...
//////////////////////////////////////////////////
ignition::common::ConnectionPtr Ogre2SonarCone::ConnectNewRgbPointCloud(
    std::function<void(const float *, unsigned int, unsigned int,
      unsigned int, const std::string &)>  _subscriber)
{
...
//////////////////////////////////////////////////
RenderTargetPtr Ogre2SonarCone::RenderTarget() const
{
  return this->dataPtr->depthTexture;
}

//////////////////////////////////////////////////
double Ogre2SonarCone::LimitFOV(const double _fov)
{
  return std::min(std::max(0.001, _fov), IGN_PI * 0.999);
}

//////////////////////////////////////////////////
void Ogre2SonarCone::SetNearClipPlane(const double _near)
{
  BaseSonarCone::SetNearClipPlane(_near);
  // near plane clipping is handled in shaders
}

//////////////////////////////////////////////////
void Ogre2SonarCone::SetFarClipPlane(const double _far)
{
  BaseSonarCone::SetFarClipPlane(_far);
  // far plane clipping is handled in shaders
}

//////////////////////////////////////////////////
double Ogre2SonarCone::NearClipPlane() const
{
  return BaseSonarCone::NearClipPlane();
}

//////////////////////////////////////////////////
double Ogre2SonarCone::FarClipPlane() const
{
  return BaseSonarCone::FarClipPlane();
}

//////////////////////////////////////////////////
void Ogre2SonarCone::SetShadowsDirty()
{
  this->SetShadowsNodeDefDirty();
}

//////////////////////////////////////////////////
void Ogre2SonarCone::SetShadowsNodeDefDirty()
{
  if (!this->dataPtr->ogreCompositorWorkspace)
    return;
...
//////////////////////////////////////////////////
void Ogre2SonarCone::AddRenderPass(const RenderPassPtr &_pass)
{
  ...
  std::shared_ptr<Ogre2SonarGaussianNoisePass> depthNoisePass =
    std::make_shared<Ogre2SonarGaussianNoisePass>();
...
//////////////////////////////////////////////////
Ogre::Camera *Ogre2SonarCone::OgreCamera() const
{
