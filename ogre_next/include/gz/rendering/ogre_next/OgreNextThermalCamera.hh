...
#ifndef GZ_RENDERING_OGRE_NEXT_OGRE_NEXTTHERMALCAMERA_HH_
#define GZ_RENDERING_OGRE_NEXT_OGRE_NEXTTHERMALCAMERA_HH_
...
namespace gz
{
  namespace rendering
  {
    ...
    //
    // Forward declaration
    class OgreNextThermalCameraPrivate;

    /// \brief Thermal camera used to render thermal data into an image buffer
    class GZ_RENDERING_OGRE_NEXT_VISIBLE OgreNextThermalCamera :
      public virtual BaseThermalCamera<OgreNextSensor>,
      public virtual OgreNextObjectInterface
    {
      /// \brief Constructor
      protected: OgreNextThermalCamera();

      /// \brief Destructor
      public: virtual ~OgreNextThermalCamera();
      ...
      private: std::unique_ptr<OgreNextThermalCameraPrivate> dataPtr;
