 ...
 *
 */
#ifndef GZ_RENDERING_OGRE_NEXT_OGRE_NEXTRENDERENGINE_HH_
#define GZ_RENDERING_OGRE_NEXT_OGRE_NEXTRENDERENGINE_HH_
...
#include "gz/rendering/ogre_next/OgreNextGzOgreRenderingMode.hh"
...
namespace gz
{
  namespace rendering
  {
    ...
    //
    // forward declaration
    class OgreNextRenderEnginePrivate;
    class OgreNextGzHlmsSphericalClipMinDistance;

    /// \brief Plugin for loading ogre render engine
    class GZ_RENDERING_OGRE_NEXT_VISIBLE OgreNextRenderEnginePlugin :
      public RenderEnginePlugin
    {
      /// \brief Constructor
      public: OgreNextRenderEnginePlugin();

      /// \brief Destructor
      public: ~OgreNextRenderEnginePlugin() = default;
    ...
    /// \brief OgreNext render engine class. A singleton class that manages the
    /// underlying ogre_next render engine, loads its plugins, and creates
    /// resources needed for the engine to run
    class GZ_RENDERING_OGRE_NEXT_VISIBLE OgreNextRenderEngine :
      public virtual BaseRenderEngine
    {
      /// \brief Constructor
      private: OgreNextRenderEngine();

      /// \brief Destructor
      public: virtual ~OgreNextRenderEngine();
      ...
      /// \brief Add path to resource in ogre_next's resource manager
      ...
      /// \brief Get the ogre_next root object
      /// \return ogre_next root object
      ...
      public:
          OgreNextGzHlmsSphericalClipMinDistance &SphericalClipMinDistance();
      ...
      public: static OgreNextRenderEngine *Instance();

      /// \brief List of scenes managed by the render engine
      private: OgreNextSceneStorePtr scenes;
      ...
      private: std::unique_ptr<OgreNextRenderEnginePrivate> dataPtr;

      /// \brief Singleton setup
      private: friend class common::SingletonT<OgreNextRenderEngine>;
    };
    }
  }
}
