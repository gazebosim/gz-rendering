...
public:
  virtual ignition::math::Color DiffuseColor() const;

public:
  virtual void SetDiffuseColor(double _r, double _g, double _b,
                               double _a = 1.0);

public:
  virtual void SetDiffuseColor(const ignition::math::Color &_color);

public:
  virtual ignition::math::Color SpecularColor() const;

public:
  virtual void SetSpecularColor(const ignition::math::Color &_color);
...
public:
  LuxCoreEngineDirectionalLight(std::string lightType);
...
public:
  LuxCoreEnginePointLight(std::string lightType);
