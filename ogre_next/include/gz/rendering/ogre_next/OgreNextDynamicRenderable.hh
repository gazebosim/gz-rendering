 ...
 *
*/
#ifndef GZ_RENDERING_OGRE_NEXT_OGRE_NEXTDYNAMICRENDERABLE_HH_
#define GZ_RENDERING_OGRE_NEXT_OGRE_NEXTDYNAMICRENDERABLE_HH_
...
namespace gz
{
  namespace rendering
  {
    ...
    class OgreNextDynamicRenderablePrivate;

    /*  \class OgreNextDynamicRenderable OgreNextDynamicRenderable.hh \
     *  gz/rendering/ogre_next/OgreNextDynamicRenderable.hh
     */
    /// \brief Dynamic renderable class that manages hardware buffers for
    /// a dynamic geometry
    class GZ_RENDERING_OGRE_NEXT_VISIBLE OgreNextDynamicRenderable
    {
      /// \brief Constructor
      /// \param[in] _scene Pointer to scene
      public: explicit OgreNextDynamicRenderable(ScenePtr _scene);

      /// \brief Virtual destructor
      public: virtual ~OgreNextDynamicRenderable();
      ...
      private: std::unique_ptr<OgreNextDynamicRenderablePrivate> dataPtr;
    };
    }
  }
}
