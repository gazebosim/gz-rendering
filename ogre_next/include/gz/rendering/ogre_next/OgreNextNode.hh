 ...
 *
 */
#ifndef GZ_RENDERING_OGRE_NEXT_OGRE_NEXTNODE_HH_
#define GZ_RENDERING_OGRE_NEXT_OGRE_NEXTNODE_HH_
...
namespace gz
{
  namespace rendering
  {
    ...
    //
    /// \brief OgreNext.x implementation of the Node class
    class GZ_RENDERING_OGRE_NEXT_VISIBLE OgreNextNode :
      public BaseNode<OgreNextObject>
    {
      /// \brief Constructor
      protected: OgreNextNode();

      /// \brief Destructor
      public: virtual ~OgreNextNode();
      ...
      protected: virtual void SetParent(OgreNextNodePtr _parent);
