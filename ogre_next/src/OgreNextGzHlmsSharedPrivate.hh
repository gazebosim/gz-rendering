 ...
 *
 */
#ifndef GZ_RENDERING_OGRE_NEXT_OGRE_NEXTGZHLMSSHAREDPRIVATE_HH_
#define GZ_RENDERING_OGRE_NEXT_OGRE_NEXTGZHLMSSHAREDPRIVATE_HH_
...
namespace gz
{
  namespace rendering
  {
    ...
    /// customizations
    /// \internal
    class GZ_RENDERING_OGRE_NEXT_HIDDEN OgreNextGzHlmsShared
    {
      /// \brief Destructor
      protected: ~OgreNextGzHlmsShared();
      ...
      /// OgreNextGzHlmsShared::BindObjectDataBuffer
