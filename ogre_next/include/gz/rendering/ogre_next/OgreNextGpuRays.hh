...
#ifndef GZ_RENDERING_OGRE_NEXT_OGRE_NEXTGPURAYS_HH_
#define GZ_RENDERING_OGRE_NEXT_OGRE_NEXTGPURAYS_HH_
...
namespace gz
{
  namespace rendering
  {
    ...
    //
    // Forward declaration
    class OgreNextGpuRaysPrivate;

    /// \brief Gpu Rays used to render range data into an image buffer
    /// The ogre_next implementation takes a 2 pass process to generate
    ...
    /// cubemap.
    class GZ_RENDERING_OGRE_NEXT_VISIBLE OgreNextGpuRays :
      public BaseGpuRays<OgreNextSensor>
    {
      /// \brief Constructor
      protected: OgreNextGpuRays();

      /// \brief Destructor
      public: virtual ~OgreNextGpuRays();
     ...
     /// \brief Create an ortho camera.
      ...
      private: std::unique_ptr<OgreNextGpuRaysPrivate> dataPtr;
