 ...
 *
 */
#ifndef GZ_RENDERING_OGRE_NEXT_OGRE_NEXTGZHLMSPBSPRIVATE_HH_
#define GZ_RENDERING_OGRE_NEXT_OGRE_NEXTGZHLMSPBSPRIVATE_HH_
...
namespace Ogre
{
  ...
  /// next render)
  class GZ_RENDERING_OGRE_NEXT_HIDDEN OgreNextGzHlmsPbs final
    : public HlmsPbs,
      public HlmsListener,
      public gz::rendering::OgreNextGzHlmsShared
  {
    ...
    public: OgreNextGzHlmsPbs(Archive *dataFolder, ArchiveVec *libraryFolders,
                            gz::rendering::
    ...
    public: virtual ~OgreNextGzHlmsPbs() override = default;
    ...
    /// OgreNextGzHlmsPbs to be bound again
