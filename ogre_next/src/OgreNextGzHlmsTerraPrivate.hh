 ...
 *
 */
#ifndef GZ_RENDERING_OGRE_NEXT_OGRE_NEXTGZHLMSTERRAPRIVATE_HH_
#define GZ_RENDERING_OGRE_NEXT_OGRE_NEXTGZHLMSTERRAPRIVATE_HH_
...
namespace Ogre
{
  ...
  /// next render)
  class GZ_RENDERING_OGRE_NEXT_HIDDEN OgreNextGzHlmsTerra final
    : public HlmsTerra,
      public HlmsListener,
      public gz::rendering::OgreNextGzHlmsShared
  {
    ...
    public: OgreNextGzHlmsTerra(Archive *dataFolder, ArchiveVec *libraryFolders,
                              gz::rendering::
                              OgreNextGzHlmsSphericalClipMinDistance
                              *_sphericalClipMinDistance);

      /// \brief Destructor. Virtual to silence warnings
    public: virtual ~OgreNextGzHlmsTerra() override = default;
    ...
    /// OgreNextGzHlmsTerra to be bound again
