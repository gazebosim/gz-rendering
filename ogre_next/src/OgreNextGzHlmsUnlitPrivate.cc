...
namespace Ogre
{
  ...
  OgreNextGzHlmsUnlit::OgreNextGzHlmsUnlit(
  ...
  /////////////////////////////////////////////////
  uint16 OgreNextGzHlmsUnlit::getNumExtraPassTextures(
  ...
  /////////////////////////////////////////////////
  void OgreNextGzHlmsUnlit::propertiesMergedPreGenerationStep(
    Hlms *_hlms,  //
  ...
  /////////////////////////////////////////////////
  void OgreNextGzHlmsUnlit::preparePassHash(
  ...
  /////////////////////////////////////////////////
  uint32 OgreNextGzHlmsUnlit::getPassBufferSize(
  ...
  /////////////////////////////////////////////////
  float *OgreNextGzHlmsUnlit::preparePassBuffer(
    const Ogre::CompositorShadowNode *_shadowNode, bool _casterPass,
  ...
  /////////////////////////////////////////////////
  void OgreNextGzHlmsUnlit::setupRootLayout(
  ...
  /////////////////////////////////////////////////
  void OgreNextGzHlmsUnlit::shaderCacheEntryCreated(
  ...
  /////////////////////////////////////////////////
  void OgreNextGzHlmsUnlit::notifyPropertiesMergedPreGenerationStep()
  {
  ...
  /////////////////////////////////////////////////
  void OgreNextGzHlmsUnlit::hlmsTypeChanged(bool _casterPass,
  ...
  /////////////////////////////////////////////////
  uint32 OgreNextGzHlmsUnlit::fillBuffersForV1(
  ...
  /////////////////////////////////////////////////
  uint32 OgreNextGzHlmsUnlit::fillBuffersForV2(
    const HlmsCache *_cache, const QueuedRenderable &_queuedRenderable,
    bool _casterPass, uint32 _lastCacheHash, CommandBuffer *_commandBuffer)
  {
  ...
  /////////////////////////////////////////////////
  void OgreNextGzHlmsUnlit::preCommandBufferExecution(
    CommandBuffer *_commandBuffer)
  {
  ...
  /////////////////////////////////////////////////
  void OgreNextGzHlmsUnlit::frameEnded()
  {
  ...
  /////////////////////////////////////////////////
  void OgreNextGzHlmsUnlit::GetDefaultPaths(String &_outDataFolderPath,
