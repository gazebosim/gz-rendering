...
class gz::rendering::OgreNextGridPrivate
{
  /// \brief Grid materal
  public: OgreNextMaterialPtr material;

  /// \brief Ogre renderable used to render the grid.
  public: std::shared_ptr<OgreNextDynamicRenderable> grid = nullptr;
};

//////////////////////////////////////////////////
OgreNextGrid::OgreNextGrid()
    : dataPtr(new OgreNextGridPrivate)
{
}
...
//////////////////////////////////////////////////
Ogre::MovableObject *OgreNextGrid::OgreObject() const
{
  return this->dataPtr->grid->OgreObject();
}

//////////////////////////////////////////////////
void OgreNextGrid::Init()
{
  this->Create();
}

//////////////////////////////////////////////////
void OgreNextGrid::Create()
{
  if (!this->dataPtr->grid)
  {
    this->dataPtr->grid.reset(new OgreNextDynamicRenderable(this->scene));
  }
...
//////////////////////////////////////////////////
void OgreNextGrid::SetMaterial(MaterialPtr _material, bool _unique)
{
...
//////////////////////////////////////////////////
void OgreNextGrid::SetMaterialImpl(OgreNextMaterialPtr _material)
{
...
//////////////////////////////////////////////////
MaterialPtr OgreNextGrid::Material() const
{
