...
namespace Ogre
{
  ...
  OgreNextGzHlmsTerra::OgreNextGzHlmsTerra(
    Archive *dataFolder, ArchiveVec *libraryFolders,
    OgreNextGzHlmsSphericalClipMinDistance *_sphericalClipMinDistance) :
  ...
  /////////////////////////////////////////////////
  uint16 OgreNextGzHlmsTerra::getNumExtraPassTextures(
  ...
  /////////////////////////////////////////////////
  void OgreNextGzHlmsTerra::propertiesMergedPreGenerationStep(
    Hlms *_hlms,  //
  ...
  /////////////////////////////////////////////////
  void OgreNextGzHlmsTerra::preparePassHash(
  ...
  /////////////////////////////////////////////////
  uint32 OgreNextGzHlmsTerra::getPassBufferSize(
  ...
  /////////////////////////////////////////////////
  float *OgreNextGzHlmsTerra::preparePassBuffer(
    const Ogre::CompositorShadowNode *_shadowNode, bool _casterPass,
  ...
  /////////////////////////////////////////////////
  void OgreNextGzHlmsTerra::setupRootLayout(
  ...
  /////////////////////////////////////////////////
  void OgreNextGzHlmsTerra::shaderCacheEntryCreated(
  ...
  /////////////////////////////////////////////////
  void OgreNextGzHlmsTerra::notifyPropertiesMergedPreGenerationStep()
  {
  ...
  /////////////////////////////////////////////////
  void OgreNextGzHlmsTerra::hlmsTypeChanged(bool _casterPass,
  ...
  /////////////////////////////////////////////////
  uint32 OgreNextGzHlmsTerra::fillBuffersForV1(
  ...
  /////////////////////////////////////////////////
  uint32 OgreNextGzHlmsTerra::fillBuffersForV2(
    const HlmsCache *_cache, const QueuedRenderable &_queuedRenderable,
    bool _casterPass, uint32 _lastCacheHash, CommandBuffer *_commandBuffer)
  {
  ...
  /////////////////////////////////////////////////
  void OgreNextGzHlmsTerra::preCommandBufferExecution(
    CommandBuffer *_commandBuffer)
  {
  ...
  /////////////////////////////////////////////////
  void OgreNextGzHlmsTerra::frameEnded()
  {
  ...
  /////////////////////////////////////////////////
  void OgreNextGzHlmsTerra::GetDefaultPaths(String &_outDataFolderPath,
