 ...
 *
 */
#ifndef GZ_RENDERING_OGRE_NEXT_OGRE_NEXTRENDERTARGETMATERIAL_HH_
#define GZ_RENDERING_OGRE_NEXT_OGRE_NEXTRENDERTARGETMATERIAL_HH_
...
namespace gz
{
  namespace rendering
  {
    ...
    class GZ_RENDERING_OGRE_NEXT_VISIBLE  OgreNextRenderTargetMaterial :
      ...
      public Ogre::MaterialManager::Listener
    {
      ...
      public: OgreNextRenderTargetMaterial(Ogre::SceneManager *_scene,
        Ogre::Camera *_renderTarget, Ogre::Material *_material);

      /// \brief destructor
      public: ~OgreNextRenderTargetMaterial();
