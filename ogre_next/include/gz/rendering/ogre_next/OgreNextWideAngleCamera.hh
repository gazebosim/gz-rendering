 ...
 *
*/
#ifndef GZ_RENDERING_OGRE_NEXT_WIDEANGLECAMERA_HH_
#define GZ_RENDERING_OGRE_NEXT_WIDEANGLECAMERA_HH_
...
namespace gz
{
  namespace rendering
  {
    ...
    class GZ_RENDERING_OGRE_NEXT_VISIBLE OgreNextWideAngleCamera :
        public BaseWideAngleCamera<OgreNextSensor>
    {
      /// \brief Constructor
      protected: OgreNextWideAngleCamera();

      /// \brief Destructor
      public: virtual ~OgreNextWideAngleCamera() override;
      ...
      private: friend class OgreNextWideAngleCameraWorkspaceListenerPrivate;
    };
    }
  }
}
