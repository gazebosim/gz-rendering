...
#ifndef GZ_RENDERING_OGRE_NEXT_OGRE_NEXTSEGMENTATIONMATERIALSWITCHER_HH_
#define GZ_RENDERING_OGRE_NEXT_OGRE_NEXTSEGMENTATIONMATERIALSWITCHER_HH_
...
/// a flat colour
class GZ_RENDERING_OGRE_NEXT_VISIBLE OgreNextSegmentationMaterialSwitcher :
  public Ogre::Camera::Listener
{
  ...
  public: OgreNextSegmentationMaterialSwitcher(OgreNextScenePtr _scene,
              SegmentationCamera *_camera);

  /// \brief Destructor
  public: ~OgreNextSegmentationMaterialSwitcher();
...
#endif  // GZ_RENDERING_OGRE_NEXT_OGRE_NEXTSEGMENTATIONMATERIALSWITCHER_HH_
