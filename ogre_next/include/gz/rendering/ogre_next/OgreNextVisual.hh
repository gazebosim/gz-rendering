 ...
 *
 */
#ifndef GZ_RENDERING_OGRE_NEXT_OGRE_NEXTVISUAL_HH_
#define GZ_RENDERING_OGRE_NEXT_OGRE_NEXTVISUAL_HH_
...
namespace gz
{
  namespace rendering
  {
    ...
    //
    // forward declaration
    class OgreNextVisualPrivate;

    /// \brief OgreNext.x implementation of the visual class
    class GZ_RENDERING_OGRE_NEXT_VISIBLE OgreNextVisual :
      public BaseVisual<OgreNextNode>
    {
      /// \brief Constructor
      protected: OgreNextVisual();

      /// \brief Destructor
      public: virtual ~OgreNextVisual();
      ...
      private: OgreNextVisualPtr SharedThis();

      /// \brief Pointer to the attached geometries
      protected: OgreNextGeometryStorePtr geometries;

      /// \brief Pointer to private data class
      private: std::unique_ptr<OgreNextVisualPrivate> dataPtr;
