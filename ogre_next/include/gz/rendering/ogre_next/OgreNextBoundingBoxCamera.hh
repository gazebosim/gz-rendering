...
#ifndef GZ_RENDERING_OGRE_NEXT_OGRE_NEXTBOUNDINGBOXCAMERA_HH_
#define GZ_RENDERING_OGRE_NEXT_OGRE_NEXTBOUNDINGBOXCAMERA_HH_
...
namespace gz
{
  namespace rendering
  {
    ...
    //
    // Forward declaration
    class OgreNextBoundingBoxCameraPrivate;

    /// \brief BoundingBox camera used to detect 2d / 3d bounding boxes
    /// of labeled objects in the scene
    class GZ_RENDERING_OGRE_NEXT_VISIBLE OgreNextBoundingBoxCamera :
      public BaseBoundingBoxCamera<OgreNextSensor>
    {
      /// \brief Constructor
      protected: OgreNextBoundingBoxCamera();

      /// \brief Destructor
      public: virtual ~OgreNextBoundingBoxCamera();
      ...
      private: std::unique_ptr<OgreNextBoundingBoxCameraPrivate> dataPtr;
