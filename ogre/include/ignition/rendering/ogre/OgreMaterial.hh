...
namespace ignition
{
  namespace rendering
  {
    ...
    const std::string depth_vertex_shader_path = "/usr/local/share/"
      "ignition/rendering-1/ogre/media/materials/programs/"
      "depth_vertex_shader.glsl";
    const std::string depth_fragment_shader_path = "/usr/local/share/"
      "ignition/rendering-1/ogre/media/materials/programs/"
