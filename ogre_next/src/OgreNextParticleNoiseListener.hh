 ...
 *
 */
#ifndef GZ_RENDERING_OGRE_NEXT_OGRE_NEXTPARTICLENOISELISTENER_HH_
#define GZ_RENDERING_OGRE_NEXT_OGRE_NEXTPARTICLENOISELISTENER_HH_
...
namespace gz
{
  namespace rendering
  {
    ...
    class OgreNextParticleNoiseListener : public Ogre::Camera::Listener
    {
      /// \brief constructor
      /// \param[in] _scene the scene manager responsible for rendering
      public: OgreNextParticleNoiseListener(OgreNextScenePtr _scene,
        Ogre::MaterialPtr _ogreMaterial);

      /// \brief destructor
      public: ~OgreNextParticleNoiseListener() = default;
