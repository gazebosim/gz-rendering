 ...
 *
 */
#ifndef GZ_RENDERING_OGRE_NEXT_OGRE_NEXTLIGHT_HH_
#define GZ_RENDERING_OGRE_NEXT_OGRE_NEXTLIGHT_HH_
...
namespace gz
{
  namespace rendering
  {
    ...
    //
    // forward declaration
    class OgreNextLightPrivate;

    /// \brief Ogre 2.x implementation of the light class
    class GZ_RENDERING_OGRE_NEXT_VISIBLE OgreNextLight :
      public BaseLight<OgreNextNode>
    {
      /// \brief Constructor
      protected: OgreNextLight();

      /// \brief Destructor
      public: virtual ~OgreNextLight();
      ...
      private: std::unique_ptr<OgreNextLightPrivate> dataPtr;
    };

    /// \brief Ogre 2.x implementation of the directional light class
    class GZ_RENDERING_OGRE_NEXT_VISIBLE OgreNextDirectionalLight :
      public BaseDirectionalLight<OgreNextLight>
    {
      /// \brief Constructor
      protected: OgreNextDirectionalLight();

      /// \brief Destructor
      public: virtual ~OgreNextDirectionalLight();
    ...
    class GZ_RENDERING_OGRE_NEXT_VISIBLE OgreNextPointLight :
      public BasePointLight<OgreNextLight>
    {
      /// \brief Constructor
      protected: OgreNextPointLight();

      /// \brief Destructor
      public: virtual ~OgreNextPointLight();
    ...
    class GZ_RENDERING_OGRE_NEXT_VISIBLE OgreNextSpotLight :
      public BaseSpotLight<OgreNextLight>
    {
      /// \brief Constructor
      protected: OgreNextSpotLight();

      /// \brief Destructor
      public: virtual ~OgreNextSpotLight();
