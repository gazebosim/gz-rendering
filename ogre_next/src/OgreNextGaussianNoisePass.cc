...
/// \brief Private data for the OgreNextGaussianNoisePass class
class gz::rendering::OgreNextGaussianNoisePassPrivate
{
...
//////////////////////////////////////////////////
OgreNextGaussianNoisePass::OgreNextGaussianNoisePass()
  : dataPtr(std::make_unique<OgreNextGaussianNoisePassPrivate>())
{
}
...
//////////////////////////////////////////////////
void OgreNextGaussianNoisePass::PreRender(const CameraPtr &/*_camera*/)
{
...
//////////////////////////////////////////////////
void OgreNextGaussianNoisePass::CreateRenderPass()
{
...
GZ_RENDERING_REGISTER_RENDER_PASS(OgreNextGaussianNoisePass, GaussianNoisePass)
