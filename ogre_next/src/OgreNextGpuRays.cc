...
class GZ_RENDERING_OGRE_NEXT_HIDDEN OgreNextLaserRetroMaterialSwitcher
  : public Ogre::CompositorWorkspaceListener
{
  ...
  public: explicit OgreNextLaserRetroMaterialSwitcher(OgreNextScenePtr _scene,
                                                   OgreNextGpuRays *_gpuRays,
                                                   Ogre::Camera *_ogreCamera);

  /// \brief destructor
  public: virtual ~OgreNextLaserRetroMaterialSwitcher() = default;
  ...
  /// \brief Scene manager
  private: OgreNextScenePtr scene = nullptr;

  /// \brief OgreNextGpuRays, our creator
  private: OgreNextGpuRays *gpuRays = nullptr;
...
/// \internal
/// \brief Private data for the OgreNextGpuRays class
class GZ_RENDERING_OGRE_NEXT_HIDDEN gz::rendering::OgreNextGpuRaysPrivate
{
  ...
  public: std::unique_ptr<OgreNextLaserRetroMaterialSwitcher>
...
//////////////////////////////////////////////////
OgreNextLaserRetroMaterialSwitcher::OgreNextLaserRetroMaterialSwitcher(
  OgreNextScenePtr _scene, OgreNextGpuRays *_gpuRays, Ogre::Camera *_ogreCamera)
{
  this->scene = _scene;
...
//////////////////////////////////////////////////
void OgreNextLaserRetroMaterialSwitcher::passPreExecute(
  Ogre::CompositorPass *_pass)
{
  if(_pass->getDefinition()->mIdentifier == kLaserRetro1stPassQuad)
  {
    ...
    OgreNextParticleNoiseListener::SetupMaterial(pass, this->scene,
                                              passQuad->getCamera());
    return;
  }
  ...
  while (itor.hasMoreElements())
  {
    ...
    if (!userAny.isEmpty() && userAny.getType() == typeid(unsigned int))
    {
      ...
      OgreNextVisualPtr ogreVisual =
          std::dynamic_pointer_cast<OgreNextVisual>(result);
    ...
    for (size_t i = 0; i < numSubItems; ++i)
    {
      ...
      if (!subItem->getMaterial().isNull())
      {
        ...
        // (i.e. it's not using OgreNextMaterial interface).
...
//////////////////////////////////////////////////
void OgreNextLaserRetroMaterialSwitcher::passPosExecute(
  Ogre::CompositorPass *_pass)
{
  if(_pass->getDefinition()->mIdentifier != kLaserRetroMainDepthPassId)
    return;
...
//////////////////////////////////////////////////
OgreNextGpuRays::OgreNextGpuRays()
  : dataPtr(new OgreNextGpuRaysPrivate)
{
...
void OgreNextGpuRays::Destroy()
{
  ...
  OgreNextNode::Destroy();
}

/////////////////////////////////////////////////
void OgreNextGpuRays::CreateRenderTexture()
{
...
/////////////////////////////////////////////////
void OgreNextGpuRays::CreateCamera()
{
...
/////////////////////////////////////////////////
void OgreNextGpuRays::ConfigureCamera()
{
...
/////////////////////////////////////////////////////////
math::Vector2d OgreNextGpuRays::SampleCubemap(const math::Vector3d &_v,
...
/////////////////////////////////////////////////////////
void OgreNextGpuRays::CreateSampleTexture()
{
...
/////////////////////////////////////////////////////////
void OgreNextGpuRays::Setup1stPass()
{
  // Create tmp textures
  auto engine = OgreNextRenderEngine::Instance();
  auto ogreRoot = engine->OgreRoot();
  ...
  GZ_ASSERT(this->dataPtr->particleTargetDef != nullptr,
            "Unable to get particle target in OgreNextGpuRays");
  ...
  for (auto i : this->dataPtr->cubeFaceIdx)
  {
    ...
    this->dataPtr->laserRetroMaterialSwitcher[i].reset(
      new OgreNextLaserRetroMaterialSwitcher(this->scene, this,
...
/////////////////////////////////////////////////////////
void OgreNextGpuRays::Setup2ndPass()
{
...
/////////////////////////////////////////////////////////
void OgreNextGpuRays::CreateGpuRaysTextures()
{
...
/////////////////////////////////////////////////
void OgreNextGpuRays::UpdateRenderTarget1stPass()
{
...
/////////////////////////////////////////////////
void OgreNextGpuRays::UpdateRenderTarget2ndPass()
{
...
void OgreNextGpuRays::Render()
{
  ...
  OgreNextGzHlmsSphericalClipMinDistance &hlmsCustomizations =
...
//////////////////////////////////////////////////
void OgreNextGpuRays::PreRender()
{
...
//////////////////////////////////////////////////
void OgreNextGpuRays::PostRender()
{
...
//////////////////////////////////////////////////
const float* OgreNextGpuRays::Data() const
{
  return this->dataPtr->gpuRaysScan;
}

//////////////////////////////////////////////////
void OgreNextGpuRays::Copy(float *_dataDest)
{
  unsigned int width = this->dataPtr->w2nd;
  unsigned int height = this->dataPtr->h2nd;
...
/////////////////////////////////////////////////
void OgreNextGpuRays::Set1stTextureSize(
...
/////////////////////////////////////////////////
void OgreNextGpuRays::SetRangeCount(
    const unsigned int _w, const unsigned int _h)
{
...
//////////////////////////////////////////////////
common::ConnectionPtr OgreNextGpuRays::ConnectNewGpuRaysFrame(
...
//////////////////////////////////////////////////
RenderTargetPtr OgreNextGpuRays::RenderTarget() const
{
