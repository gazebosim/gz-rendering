...
/////////////////////////////////////////////////
OgreNextBoundingBoxMaterialSwitcher::OgreNextBoundingBoxMaterialSwitcher(
...
////////////////////////////////////////////////
VisualPtr OgreNextBoundingBoxMaterialSwitcher::TopLevelModelVisual(
...
////////////////////////////////////////////////
void OgreNextBoundingBoxMaterialSwitcher::cameraPreRenderScene(
    Ogre::Camera * /*_cam*/)
{
  ...
  while (itor.hasMoreElements())
  {
    ...
    if (!userAny.isEmpty() && userAny.getType() == typeid(unsigned int))
    {
      ...
      OgreNextVisualPtr ogreVisual = std::dynamic_pointer_cast<OgreNextVisual>(
        visual);
...
/////////////////////////////////////////////////
void OgreNextBoundingBoxMaterialSwitcher::cameraPostRenderScene(
    Ogre::Camera * /*_cam*/)
{
