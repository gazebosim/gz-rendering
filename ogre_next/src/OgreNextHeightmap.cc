...
//////////////////////////////////////////////////
class gz::rendering::OgreNextHeightmapPrivate
{
...
//////////////////////////////////////////////////
OgreNextHeightmap::OgreNextHeightmap(const HeightmapDescriptor &_desc)
    : BaseHeightmap(_desc),
      dataPtr(std::make_unique<OgreNextHeightmapPrivate>())
{
}

//////////////////////////////////////////////////
OgreNextHeightmap::~OgreNextHeightmap()
{
  this->Destroy();
}

//////////////////////////////////////////////////
void OgreNextHeightmap::Destroy()
{
  this->dataPtr->terra.reset();
}

//////////////////////////////////////////////////
void OgreNextHeightmap::Init()
{
  ...
  for (uint64_t i = 0u; i < this->descriptor.TextureCount(); ++i)
  {
    ...
    OgreNextRenderEngine::Instance()->AddResourcePath(texture->Diffuse());
    OgreNextRenderEngine::Instance()->AddResourcePath(texture->Normal());
  }
  ...
  this->dataPtr->terra->load(
        image,
        OgreNextConversions::Convert(center),
        OgreNextConversions::Convert(size),
        false,
        false,
  ...
  if (numTextures >= 1u)
  {
    ...
    {
      gzwarn << "OgreNextHeightmap currently supports up to 4 textures, "
    ...
    {
      gzwarn << "OgreNextHeightmap currently supports up to 3 blends, "
...
//////////////////////////////////////////////////
void OgreNextHeightmap::PreRender()
{
}

///////////////////////////////////////////////////
void OgreNextHeightmap::UpdateForRender(Ogre::Camera *_activeCamera)
{
  ...
  OgreNextDirectionalLightPtr directionalLight;
  for (unsigned int i = 0; i < this->Scene()->LightCount(); ++i)
  {
     auto light = std::dynamic_pointer_cast<OgreNextDirectionalLight>(
  ...
  if (directionalLight)
  {
    this->dataPtr->terra->update(
          OgreNextConversions::Convert(directionalLight->Direction()));
  }
  else
  {
...
//////////////////////////////////////////////////
Ogre::MovableObject *OgreNextHeightmap::OgreObject() const
{
  return this->dataPtr->terra.get();
}

//////////////////////////////////////////////////
void OgreNextHeightmap::SetMaterial(MaterialPtr, bool)
{
  // no-op
}

//////////////////////////////////////////////////
MaterialPtr OgreNextHeightmap::Material() const
{
  return nullptr;
}

//////////////////////////////////////////////////
Ogre::Terra* OgreNextHeightmap::Terra()
{
  return this->dataPtr->terra.get();
}
