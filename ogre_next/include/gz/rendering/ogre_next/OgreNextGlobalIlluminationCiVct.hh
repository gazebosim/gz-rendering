 ...
 *
 */
#ifndef GZ_RENDERING_OGRE_NEXT_OGRE_NEXTGLOBALILLUMINATIONCIVCT_HH_
#define GZ_RENDERING_OGRE_NEXT_OGRE_NEXTGLOBALILLUMINATIONCIVCT_HH_
...
namespace gz
{
  namespace rendering
  {
    ...
    //
    // forward declaration
    class OgreNextCiVctCascadePrivate;
    class OgreNextGlobalIlluminationCiVctPrivate;

    /// \brief OgreNext.x implementation of the CiVctCascade class
    class GZ_RENDERING_OGRE_NEXT_VISIBLE OgreNextCiVctCascade :
      public virtual CiVctCascade
    {
      /// \brief Constructor
      public: explicit OgreNextCiVctCascade();

      public: ~OgreNextCiVctCascade() override;
      ...
      /// See OgreNextGlobalIlluminationCiVct::Reset
      ...
      private: std::unique_ptr<OgreNextCiVctCascadePrivate> dataPtr;
    };

    /// \brief OgreNext.x implementation of the GlobalIlluminationCiVct class
    class GZ_RENDERING_OGRE_NEXT_VISIBLE OgreNextGlobalIlluminationCiVct :
      public virtual GlobalIlluminationCiVct, public virtual OgreNextObject
    {
      /// \brief Constructor
      protected: OgreNextGlobalIlluminationCiVct();

      /// \brief Destructor
      public: virtual ~OgreNextGlobalIlluminationCiVct() override;
      ...
      /// \brief Pointer to private data class
      private: std::unique_ptr<OgreNextGlobalIlluminationCiVctPrivate> dataPtr;
