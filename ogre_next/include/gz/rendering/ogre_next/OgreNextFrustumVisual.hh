...
#ifndef GZ_RENDERING_OGRE_NEXT_OGREFRUSTUMVISUAL_HH_
#define GZ_RENDERING_OGRE_NEXT_OGREFRUSTUMVISUAL_HH_
...
namespace gz
{
  namespace rendering
  {
    ...
    //
    // Forward declaration
    class OgreNextFrustumVisualPrivate;

    /// \brief Ogre 2.x implementation of a Frustum Visual.
    class GZ_RENDERING_OGRE_NEXT_VISIBLE OgreNextFrustumVisual
      : public BaseFrustumVisual<OgreNextVisual>
    {
      /// \brief Constructor
      protected: OgreNextFrustumVisual();

      /// \brief Destructor
      public: virtual ~OgreNextFrustumVisual();
      ...
      private: std::unique_ptr<OgreNextFrustumVisualPrivate> dataPtr;
    };
    }
  }
}
