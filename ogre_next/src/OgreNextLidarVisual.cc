...
class gz::rendering::OgreNextLidarVisualPrivate
{
  /// \brief Non Hitting DynamicLines Object to display
  public: std::vector<std::shared_ptr<OgreNextDynamicRenderable>>
      noHitRayStrips;

  /// \brief Hitting DynamicLines Object to display
  public: std::vector<std::shared_ptr<OgreNextDynamicRenderable>> rayStrips;
  ...
  public: std::vector<std::shared_ptr<OgreNextDynamicRenderable>> rayLines;

  /// \brief Lidar Points DynamicLines Object to display
  public: std::vector<std::shared_ptr<OgreNextDynamicRenderable>> points;
...
//////////////////////////////////////////////////
OgreNextLidarVisual::OgreNextLidarVisual()
  : dataPtr(new OgreNextLidarVisualPrivate)
{
}
...
//////////////////////////////////////////////////
void OgreNextLidarVisual::PreRender()
{
  // no ops
}

//////////////////////////////////////////////////
void OgreNextLidarVisual::Destroy()
{
...
//////////////////////////////////////////////////
void OgreNextLidarVisual::Create()
{
...
//////////////////////////////////////////////////
void OgreNextLidarVisual::ClearPoints()
{
  this->dataPtr->lidarPoints.clear();
...
//////////////////////////////////////////////////
void OgreNextLidarVisual::ClearVisualData()
{
...
//////////////////////////////////////////////////
void OgreNextLidarVisual::SetPoints(const std::vector<double> &_points)
{
...
//////////////////////////////////////////////////
void OgreNextLidarVisual::Update()
{
  ...
  for (unsigned int j = 0; j < this->verticalCount; ++j)
  {
        ...
        this->dataPtr->lidarVisType == LidarVisualType::LVT_TRIANGLE_STRIPS)
    {
      ...
      {
        std::shared_ptr<OgreNextDynamicRenderable> renderable =
            std::shared_ptr<OgreNextDynamicRenderable>(
        ...
        {
          renderable = std::shared_ptr<OgreNextDynamicRenderable>(
                                  new OgreNextDynamicRenderable(this->Scene()));
...
//////////////////////////////////////////////////
unsigned int OgreNextLidarVisual::PointCount() const
{
  return this->dataPtr->lidarPoints.size();
}

//////////////////////////////////////////////////
std::vector<double> OgreNextLidarVisual::Points() const
{
  return this->dataPtr->lidarPoints;
}

//////////////////////////////////////////////////
void OgreNextLidarVisual::SetVisible(bool _visible)
{
