...
#ifndef GZ_RENDERING_OGRE_NEXT_OGRE_NEXTGZHLMSCUSTOMIZATIONS_HH_
#define GZ_RENDERING_OGRE_NEXT_OGRE_NEXTGZHLMSCUSTOMIZATIONS_HH_
...
namespace gz
{
  namespace rendering
  {
    ...
    /// next render)
    class GZ_RENDERING_OGRE_NEXT_HIDDEN OgreNextGzHlmsSphericalClipMinDistance
      final : public Ogre::HlmsListener
    {
      public: virtual ~OgreNextGzHlmsSphericalClipMinDistance() = default;
      ...
      /// OgreNextGzHlmsSphericalClipMinDistance::preparePassBuffer
      /// \param _casterPass
      /// \param _hlms
      ...
      /// pieces activated in
      /// OgreNextGzHlmsSphericalClipMinDistance::preparePassHash will need.
      ///
