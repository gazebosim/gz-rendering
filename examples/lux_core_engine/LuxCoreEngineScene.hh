...
protected:
  LuxCoreEngineScene(unsigned int _id, const std::string &_name);

public:
  virtual ~LuxCoreEngineScene();
...
protected:
  bool InitObject(LuxCoreEngineObjectPtr _object, unsigned int _id,
                  const std::string &_name);

private:
  LuxCoreEngineScenePtr SharedThis();

public:
  luxcore::Scene *SceneLux();
...
protected:
  LuxCoreEngineMeshFactoryPtr meshFactory;

protected:
  LuxCoreEngineMaterialMapPtr materials;

protected:
  LuxCoreEngineSensorStorePtr sensors;

protected:
  LuxCoreEngineVisualStorePtr visuals;

protected:
  LuxCoreEngineLightStorePtr lights;

private:
  friend class LuxCoreEngineRenderEngine;
};
