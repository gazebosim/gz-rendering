...
#ifndef GZ_RENDERING_OGRE_NEXT_OGRE_NEXTHEIGHTMAP_HH_
#define GZ_RENDERING_OGRE_NEXT_OGRE_NEXTHEIGHTMAP_HH_
...
namespace gz
{
  namespace rendering
  {
    ...
    //
    // Forward declaration
    class OgreNextHeightmapPrivate;

    /// \brief Ogre implementation of a heightmap geometry.
    class GZ_RENDERING_OGRE_NEXT_VISIBLE OgreNextHeightmap
      : public BaseHeightmap<OgreNextGeometry>
    {
      /// \brief Constructor
      /// \param[in] _desc Parameters describing how a
      /// heightmap should be loaded
      public: explicit OgreNextHeightmap(const HeightmapDescriptor &_desc);

      /// \brief Destructor
      public: virtual ~OgreNextHeightmap() override;
      ...
      private: std::unique_ptr<OgreNextHeightmapPrivate> dataPtr;
    };
    }
  }
}
