...
#ifndef GZ_RENDERING_OGRE_NEXT_OGRE_NEXTMATERIALSWITCHER_HH_
#define GZ_RENDERING_OGRE_NEXT_OGRE_NEXTMATERIALSWITCHER_HH_
...
namespace gz
{
  namespace rendering
  {
    ...
    class GZ_RENDERING_OGRE_NEXT_VISIBLE OgreNextMaterialSwitcher :
      public Ogre::Camera::Listener
    {
      /// \brief Constructor
      public: explicit OgreNextMaterialSwitcher(OgreNextScenePtr _scene);

      /// \brief Destructor
      public: ~OgreNextMaterialSwitcher();
      ...
      /// selecting entitiies
      public: friend class OgreNextSelectionBuffer;
