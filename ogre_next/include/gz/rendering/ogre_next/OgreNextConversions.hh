 ...
 *
 */
#ifndef GZ_RENDERING_OGRE_NEXT_OGRE_NEXTCONVERSIONS_HH_
#define GZ_RENDERING_OGRE_NEXT_OGRE_NEXTCONVERSIONS_HH_
...
namespace gz
{
  namespace rendering
  {
    ...
    /// data types
    class GZ_RENDERING_OGRE_NEXT_VISIBLE OgreNextConversions
    {
