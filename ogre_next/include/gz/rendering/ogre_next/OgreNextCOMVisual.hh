...
#ifndef GZ_RENDERING_OGRE_OGRE_NEXTCOMVISUAL_HH_
#define GZ_RENDERING_OGRE_OGRE_NEXTCOMVISUAL_HH_
...
namespace gz
{
  namespace rendering
  {
    ...
    // Forward declaration
    class OgreNextCOMVisualPrivate;

    class GZ_RENDERING_OGRE_NEXT_VISIBLE OgreNextCOMVisual :
      public BaseCOMVisual<OgreNextVisual>
    {
      /// \brief Constructor
      protected: OgreNextCOMVisual();

      /// \brief Destructor
      public: virtual ~OgreNextCOMVisual();
      ...
      private: std::unique_ptr<OgreNextCOMVisualPrivate> dataPtr;
    };
    }
  }
}
